 ...
 *
 */
export declare const useExport: <TData extends BaseRecord = BaseRecord, TVariables = any>({ resourceName, resource: resourceFromProps, sorter, sorters, filters, maxItemCount, pageSize, mapData, exportOptions, meta, metaData, dataProviderName, onError, }?: UseExportOptionsType<TData, TVariables>) => UseExportReturnType;
export {};
