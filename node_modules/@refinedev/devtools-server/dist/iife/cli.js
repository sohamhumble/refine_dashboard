#!/usr/bin/env node
(()=>{var Ce=Object.create;var x=Object.defineProperty;var xe=Object.getOwnPropertyDescriptor;var je=Object.getOwnPropertyNames;var Ne=Object.getPrototypeOf,Ve=Object.prototype.hasOwnProperty;var c=(e=>typeof require<"u"?require:typeof Proxy<"u"?new Proxy(e,{get:(t,r)=>(typeof require<"u"?require:t)[r]}):e)(function(e){if(typeof require<"u")return require.apply(this,arguments);throw new Error('Dynamic require of "'+e+'" is not supported')});var Ue=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var Fe=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of je(t))!Ve.call(e,i)&&i!==r&&x(e,i,{get:()=>t[i],enumerable:!(n=xe(t,i))||n.enumerable});return e};var d=(e,t,r)=>(r=e!=null?Ce(Ne(e)):{},Fe(t||!e||!e.__esModule?x(r,"default",{value:e,enumerable:!0}):r,e));var y=Ue((pt,W)=>{var He=Object.create,_=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,We=Object.getOwnPropertyNames,$e=Object.getPrototypeOf,Ge=Object.prototype.hasOwnProperty,Je=(e,t)=>{for(var r in t)_(e,r,{get:t[r],enumerable:!0})},j=(e,t,r,n)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of We(t))!Ge.call(e,i)&&i!==r&&_(e,i,{get:()=>t[i],enumerable:!(n=Me(t,i))||n.enumerable});return e},qe=(e,t,r)=>(r=e!=null?He($e(e)):{},j(t||!e||!e.__esModule?_(r,"default",{value:e,enumerable:!0}):r,e)),Be=e=>j(_({},"__esModule",{value:!0}),e),N={};Je(N,{DevToolsContext:()=>M,DevToolsContextProvider:()=>Qe,DevtoolsEvent:()=>V,hooksByScope:()=>Ke,receive:()=>H,scopes:()=>U,send:()=>F});W.exports=Be(N);var V=(e=>(e.RELOAD="devtools:reload",e.DEVTOOLS_INIT="devtools:init",e.DEVTOOLS_HANDSHAKE="devtools:handshake",e.DEVTOOLS_ALREADY_CONNECTED="devtools:already-connected",e.ACTIVITY="devtools:send-activity",e.DEVTOOLS_ACTIVITY_UPDATE="devtools:activity-update",e.DEVTOOLS_CONNECTED_APP="devtools:connected-app",e.DEVTOOLS_DISCONNECTED_APP="devtools:disconnected-app",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR="devtools:highlight-in-monitor",e.DEVTOOLS_HIGHLIGHT_IN_MONITOR_ACTION="devtools:highlight-in-monitor-action",e.DEVTOOLS_LOGIN_SUCCESS="devtools:login-success",e.DEVTOOLS_RELOAD_AFTER_LOGIN="devtools:reload-after-login",e))(V||{}),U={useCan:"access-control",useLog:"audit-log",useLogList:"audit-log",useCreate:"data",useCreateMany:"data",useCustom:"data",useCustomMutation:"data",useDelete:"data",useDeleteMany:"data",useInfiniteList:"data",useList:"data",useMany:"data",useOne:"data",useUpdate:"data",useUpdateMany:"data",useForgotPassword:"auth",useGetIdentity:"auth",useIsAuthenticated:"auth",useLogin:"auth",useLogout:"auth",useOnError:"auth",usePermissions:"auth",useRegister:"auth",useUpdatePassword:"auth"},Ke=Object.entries(U).reduce((e,[t,r])=>(e[r]||(e[r]=[]),e[r].push(t),e),{}),v=qe(c("react"));async function F(e,t,r){if(e.readyState!==e.OPEN){await new Promise(n=>{let i=()=>{e.send(JSON.stringify({event:t,payload:r})),n(),e.removeEventListener("open",i)};e.addEventListener("open",i)});return}else{e.send(JSON.stringify({event:t,payload:r}));return}}function H(e,t,r){let n=i=>{let{event:a,payload:s}=JSON.parse(i.data);t===a&&r(s)};return e.addEventListener("message",n),()=>{e.removeEventListener("message",n)}}var M=v.default.createContext({__devtools:!1,port:5002,url:"localhost",secure:!1,ws:null}),Qe=({__devtools:e,port:t,children:r})=>{let[n,i]=v.default.useState({__devtools:e??!1,port:t??5002,url:"localhost",secure:!1,ws:null}),[a,s]=v.default.useState(null);v.default.useEffect(()=>{let l=new WebSocket(`${n.secure?"wss":"ws"}://localhost:${n.port}`),u=H(l,"devtools:handshake",k=>{i(P=>({...P,devtoolsUrl:k.url})),u()});return l.addEventListener("open",()=>{n.__devtools||F(l,"devtools:init",{url:window.location.origin})}),s(l),()=>{u(),l.close(1e3,window.location.origin)}},[]);let o=v.default.useMemo(()=>({...n,ws:a}),[n,a]);return v.default.createElement(M.Provider,{value:o},r)}});var be=d(c("express")),m=d(y());var $=d(c("express")),b=d(c("path")),G=e=>{e.use($.default.static(b.default.join(__dirname,"client"))),e.use((t,r,n)=>{if(t.path.startsWith("/api")||t.path.startsWith("/open-in-editor"))return n();r.status(200).sendFile(b.default.join(__dirname+"/client/index.html"))})};var q=d(c("ws"));var E="https://cloud2.refine.dev",J="https://raw.githubusercontent.com/refinedev/refine/master/packages/devtools-server/FEED.md";var A=d(y()),g=c("chalk"),B=()=>{let e=new q.default.Server({port:5002}).on("error",t=>{(t==null?void 0:t.code)==="EADDRINUSE"?console.error(`
