...
`)});process.on("SIGTERM",()=>{t.close(()=>{})})};var oe={connectedApp:null,clientWs:null,devtoolsWsClients:[],appWsClients:[],activities:[],packages:[]},D=()=>({...oe});import{json as Te}from"express";import we from"lodash/uniq";import ae from"node-fetch";import se from"gray-matter";import{marked as E}from"marked";import R from"sanitize-html";var ce=e=>e.split("---section").slice(1).map(r=>`---section${r}`),le=e=>{let t=new E.Renderer;t.link=function(...n){return E.Renderer.prototype.link.apply(this,n).replace(/^<a/,'<a target="_blank" rel="noopener noreferrer"')};let r=E(e,{renderer:t});return R(r,{allowedTags:R.defaults.allowedTags.concat(["img"]),allowedAttributes:{...R.defaults.allowedAttributes,img:["src"]}})},de=e=>{let t=se(e.replace("---section","---"));return{...t.data,content:le(t.content)}},pe=async()=>{try{return(await ae(b)).text()}catch{return""}},j=async()=>{try{let e=await pe();return ce(e).map(de)}catch{return[]}};import ue from"fs";import me from"path";import fe from"globby";var C=async e=>{try{let t=await fe(`node_modules/${e}/package.json`,{onlyFiles:!0}),r=null;try{let n=u.resolve(me.join(e,"package.json"));n&&(r=n)}catch{}return[...t,...r?[r]:[]][0]??null}catch{return null}};var N=async e=>{try{let t=await C(e);if(!t)return null;let r=JSON.parse(ue.readFileSync(t,{encoding:"utf-8"}));return{name:r.name,version:r.version,description:r.description}}catch{return null}};import ve from"path";import{readJSON as ge}from"fs-extra";var h=async(e=process.cwd())=>{let t=await ge(ve.join(e,"package.json"),{encoding:"utf-8"});return Object.keys(t.dependencies).filter(n=>n.startsWith("@refinedev/"))};var V=e=>e.replace("@refinedev/","https://c.refine.dev/");var U=e=>"https://refine.dev/docs/api-reference/general-concepts/";var F=async e=>{try{let t=await h(e);return await Promise.all(t.map(async n=>{let s=await N(n);return{name:n,currentVersion:s==null?void 0:s.version,description:s==null?void 0:s.description,changelog:V(n),documentation:U(n)}}))}catch{return[]}};import l from"dedent";var he=[{name:"@refinedev/ably",description:"Ably integration for refine",install:"npm install @refinedev/ably",usage:l(`
        ...
        `.trim())},{name:"@refinedev/mantine",description:"Mantine UI integration for refine",install:"npm install @refinedev/mantine @refinedev/react-table @mantine/core @mantine/hooks @mantine/form @mantine/notifications @emotion/react @tabler/icons",usage:l(`
            ...
            `.trim())}],W=async e=>{let t=await h(e);return he.filter(r=>!t.includes(r.name))};import Pe from"preferred-pm";import ye from"execa";var $=async(e,t=process.cwd())=>{try{let{name:r}=await Pe(t)??{name:"npm"},{failed:n}=await ye(r??"npm",["install",...e.map(s=>`${s}@latest`)]);return!n}catch{return!1}};import _e from"execa";var H=async e=>{try{let{stdout:t}=await _e("npm",["view",e,"name","version","--json"]);return JSON.parse(t)}catch{return{name:e}}};import{readJSON as Ae}from"fs-extra";import Ee from"path";var P=async(e=process.cwd())=>{var t;try{let r=await Ae(Ee.join(e,"package.json"),{encoding:"utf-8"}),n=(t=r==null?void 0:r.refine)==null?void 0:t.projectId;return n||!1}catch{return null}};import Re from"execa";var M=async(e,t=process.cwd())=>{try{return Re.sync("npm",["pkg","set",`refine.projectId=${e}`],{cwd:t}),!0}catch{return null}};import ke from"execa";import q from"path";var G=async(e,t=process.cwd())=>{try{let r=u.resolve(".bin/jscodeshift"),n=ke.sync(r,["./","--extensions=ts,tsx,js,jsx","--parser=tsx",`--transform=${q.resolve(q.join(__dirname,"..","src","project-id","transform.ts"))}`,"--ignore-pattern=**/.cache/**","--ignore-pattern=**/node_modules/**","--ignore-pattern=**/build/**","--ignore-pattern=**/dist/**","--ignore-pattern=**/.next/**",`--__projectId=${e}`],{cwd:t,timeout:1e3*10});n.stderr&&console.error(n.stderr)}catch(r){console.error(r)}};var J=async(e,t=process.cwd())=>{try{return await Promise.all([M(e,t),G(e,t)]),!0}catch{return!1}};var B=(e,t)=>{e.use("/api",Te()),e.get("/api/connected-app",(a,i)=>{i.json({url:t.connectedApp})}),e.get("/api/activities",(a,i)=>{let{offset:c=0,limit:d=t.activities.length}=a.query;i.setHeader("x-total-count",t.activities.length),i.json({data:t.activities.slice(Number(c),Number(d))})}),e.get("/api/activities/reset",(a,i)=>{t.activities=[],i.json({success:!0})}),e.get("/api/unique-trace-items",(a,i)=>{i.header("Access-Control-Allow-Origin","*"),i.header("Access-Control-Allow-Headers","Origin, X-Requested-With, Content-Type, Accept");let c=t.activities.flatMap(X=>{var k;return((k=X.trace)==null?void 0:k.map(Z=>Z.function).filter(Boolean))??[]}),d=we(c);i.setHeader("x-total-count",d.length),i.json({data:d})});let r=null;e.get("/api/installed-packages",async(a,i)=>{let{force:c}=a.query??{};(!r||c)&&(r=await F()),i.header("x-total-count",`${r.length}`),i.json({data:r})});let n=null;e.get("/api/available-packages",async(a,i)=>{n||(n=await W()),i.header("x-total-count",`${n.length}`),i.json({data:n})});let s=new Map;e.get("/api/packages/:packageName/latest",async(a,i)=>{let{packageName:c}=a.params??{};if(!c){i.status(400).json({error:"Package name is required"});return}if(!s.has(c)){let d=await H(c);s.set(c,d)}return i.json({data:s.get(c)})}),e.post("/api/packages/install",async(a,i)=>{let{packages:c}=a.body??{};if((c==null?void 0:c.length)===0){i.status(400).json({error:"Package name is required"});return}await $(c)?(r=null,n=null,i.status(200).json({success:!0})):i.status(400).json({success:!1,error:"Failed to update package"})});let o=null;e.get("/api/feed",async(a,i)=>{o||(o=await j()),i.header("x-total-count",`${o.length}`),i.json({data:o})}),e.get("/api/project-id/status",async(a,i)=>{let c=await P();if(c){i.status(200).json({projectId:c});return}else if(c===!1){i.status(404).json({projectId:null});return}else{i.status(500).json({projectId:null});return}}),e.post("/api/project-id/update",async(a,i)=>{let{projectId:c}=a.body??{};if(!c){i.status(400).json({error:"Project ID is required"});return}if(await J(c)){i.status(200).json({success:!0});return}else{i.status(500).json({success:!1,error:"Failed to update project ID"});return}})};import{readJSON as be,writeJSON as Se}from"fs-extra";import{FrontendApi as Oe}from"@ory/client";import{createProxyMiddleware as K}from"http-proxy-middleware";import Q from"path";var y=null,Ie=async(e,t,r)=>{y||(y=await P()),y&&(e.headers["x-project-id"]=y),r()},Le=function(e,t){if(t.body){let r=JSON.stringify(t.body);e.setHeader("Content-Type","application/json"),e.setHeader("Content-Length",Buffer.byteLength(r)),e.write(r)}},xe=async e=>{try{let t=`${v}/.auth`,r=new Oe({isJsonMime:()=>!0,basePath:t,baseOptions:{withCredentials:!0}}),{data:n}=await r.toSession({xSessionToken:e,tokenizeAs:"jwt_template_1"});return n==null?void 0:n.tokenized}catch{}},De=async(e,t)=>{try{Se(Q.join(__dirname,"..",".persist.json"),{token:e,jwt:t})}catch{}},je=async()=>{try{return await be(Q.join(__dirname,"..",".persist.json"))}catch{}return{token:void 0,jwt:void 0}},Ce=e=>function(t,r){if(r.url.includes("self-service/logout/api")){let n=JSON.stringify({session_token:e});t.setHeader("Content-Length",Buffer.byteLength(n)),t.write(n)}},Ne=e=>function(t,r,n){let s="";t.on("data",o=>{s+=o}),t.on("end",()=>{var a;let o;try{o=JSON.parse(s).session_token}catch{}if(!o){if((a=s==null?void 0:s.includes)!=null&&a.call(s,"an+account+with+the+same+identifier")){n.redirect("/after-login?error=An+account+with+the+same+identifier+exists+already");return}n.redirect("/after-login?error=Invalid-session-token");return}xe(o).then(i=>{e(o,i??""),n.redirect("/after-login")})})},Y=async e=>{let{token:t,jwt:r}=await je(),n=K({target:v,changeOrigin:!0,pathRewrite:{"^/api/.auth":"/.auth"},cookieDomainRewrite:{"refine.dev":""},logLevel:"silent",headers:{"auth-base-url-rewrite":`http://localhost:${5001}/api/.auth`},selfHandleResponse:!0,onProxyReq:(o,a,...i)=>{t&&(o.setHeader("X-Session-Token",t??""),Ce(t)(o,a,...i))},onProxyRes:(o,a,i)=>{if(a.url.includes("self-service/methods/oidc/callback"))return Ne((c,d)=>{t=c,r=d,De(t,r)})(o,a,i);i.writeHead(o.statusCode||500,o.headers),o.pipe(i,{end:!0})}});e.use("/api/.auth",n);let s=K({target:v,secure:!1,changeOrigin:!0,logLevel:"silent",pathRewrite:{"^/api/.refine":"/.refine"},onProxyReq:(o,...a)=>{r&&(o.setHeader("Authorization",`Bearer ${r}`),o.removeHeader("cookie")),Le(o,...a)}});e.use("/api/.refine",Ie,s)};import Ve from"path";var z=(e,t)=>{e.get("/open-in-editor/*",(r,n)=>{let{line:s,column:o}=r.query,a=r.path.replace("/open-in-editor",""),i=`vscode://file/${Ve.join(t,a)}?${s?`line=${s}`:""}${o?`&column=${o}`:""}`;n.redirect(i)})};var Tr=async({projectPath:e=process.cwd()}={})=>{let t=Ue(),r=I(),n=D();r.on("connection",s=>{_(s,p.DEVTOOLS_INIT,o=>{n.connectedApp?m(s,p.DEVTOOLS_ALREADY_CONNECTED,{url:n.connectedApp}):(n.connectedApp=o.url,n.clientWs=s,r.clients.forEach(a=>{m(a,p.DEVTOOLS_CONNECTED_APP,{url:n.connectedApp})}))}),_(s,p.ACTIVITY,o=>{let a=n.activities.findIndex(c=>c.identifier===o.identifier),i={...o,createdAt:Date.now(),updatedAt:Date.now()};a>-1?(i.createdAt=n.activities[a].createdAt,n.activities[a]=i):n.activities.push(i),r.clients.forEach(c=>{m(c,p.DEVTOOLS_ACTIVITY_UPDATE,{updatedActivities:[i]})})}),_(s,p.DEVTOOLS_HIGHLIGHT_IN_MONITOR,({name:o})=>{r.clients.forEach(a=>{m(a,p.DEVTOOLS_HIGHLIGHT_IN_MONITOR_ACTION,{name:o})})}),_(s,p.DEVTOOLS_LOGIN_SUCCESS,()=>{r.clients.forEach(o=>{m(o,p.DEVTOOLS_RELOAD_AFTER_LOGIN,{})})}),s.on("close",(o,a)=>{n.clientWs&&(r.clients.has(n.clientWs)||(n.clientWs=null,n.connectedApp=null,n.activities=[],r.clients.forEach(i=>{m(i,p.DEVTOOLS_DISCONNECTED_APP,{url:n.connectedApp})})))})}),L(r),w(t),x(t),B(t,n),Y(t),z(t,e)};export{Tr as server};
