...
import {
  ...
  upload_default,
  useStyleRegister
} from "./chunk-67UT36LR.js";
import "./chunk-GHKXUZME.js";
import {
  AC,
  Ce,
  Cu,
  ...
  ze,
  zo
} from "./chunk-TYZGX2V6.js";
import "./chunk-ZFKR73HT.js";
import {
  require_dayjs_min
} from "./chunk-XW7WIN2Y.js";
import {
  require_jsx_runtime
...
import {
  ...
  init_public_api,
  require_classnames
} from "./chunk-IC76YGCX.js";
import "./chunk-HTHQKSPX.js";
import {
  __assign
} from "./chunk-DG44VFMT.js";
import "./chunk-BT45J3G4.js";
  ...
  "node_modules/dayjs/plugin/localizedFormat.js"(exports, module) {
    !function(e2, t2) {
      ...
      return function(t2, o2, n2) {
        var r = o2.prototype, i = r.format;
        n2.en.formats = e2, r.format = function(t3) {
          void 0 === t3 && (t3 = "YYYY-MM-DDTHH:mm:ssZ");
          var o3 = this.$locale().formats, n3 = function(t4, o4) {
            return t4.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(t5, n4, r2) {
              var i2 = r2 && r2.toUpperCase();
              return n4 || o4[r2] || e2[r2] || o4[i2].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(e3, t6, o5) {
...
var require_ast_to_react = __commonJS({
  "node_modules/react-markdown/src/ast-to-react.js"(exports) {
    ...
    function toReact(context, node, index, parent) {
      ...
      const basic = typeof component === "string" || component === React45.Fragment;
      ...
      return children.length > 0 ? React45.createElement(component, properties, children) : React45.createElement(component, properties);
    }
...
var require_react_markdown = __commonJS({
  "node_modules/react-markdown/src/react-markdown.js"(exports, module) {
    ...
    function ReactMarkdown(options) {
      ...
      let result = React45.createElement(
        React45.Fragment,
        {},
        childrenToReact({ options, schema: html, listDepth: 0 }, hastNode)
      );
      if (options.className) {
        result = React45.createElement("div", { className: options.className }, result);
      }
      return result;
    }
...
var require_zh_cn = __commonJS({
  "node_modules/dayjs/locale/zh-cn.js"(exports, module) {
    !function(e2, _2) {
      "object" == typeof exports && "undefined" != typeof module ? module.exports = _2(require_dayjs_min()) : "function" == typeof define && define.amd ? define(["dayjs"], _2) : (e2 = "undefined" != typeof globalThis ? globalThis : e2 || self).dayjs_locale_zh_cn = _2(e2.dayjs);
    }(exports, function(e2) {
      "use strict";
      function _2(e3) {
      ...
      return function(e2, i) {
        ...
        r.startOf = function(e3, i2) {
          ...
          if (r2.p(e3) === n2) {
            ...
            return s2 ? this.month(3 * o2).startOf(t2).startOf("day") : this.month(3 * o2 + 2).endOf(t2).endOf("day");
          }
...
var require_typeof = __commonJS({
  "node_modules/@babel/runtime/helpers/typeof.js"(exports, module) {
    function _typeof3(o2) {
      ...
      return module.exports = _typeof3 = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(o3) {
        return typeof o3;
      } : function(o3) {
        return o3 && "function" == typeof Symbol && o3.constructor === Symbol && o3 !== Symbol.prototype ? "symbol" : typeof o3;
      }, module.exports.__esModule = true, module.exports["default"] = module.exports, _typeof3(o2);
    }
...
var require_AntdIcon = __commonJS({
  "node_modules/@ant-design/icons/lib/components/AntdIcon.js"(exports) {
    ...
    var Icon = React45.forwardRef(function(props, ref) {
      var _classNames;
      ...
      var _React$useContext = React45.useContext(_Context.default), _React$useContext$pre = _React$useContext.prefixCls, prefixCls = _React$useContext$pre === void 0 ? "anticon" : _React$useContext$pre, rootClassName = _React$useContext.rootClassName;
      ...
      var _normalizeTwoToneColo = (0, _utils.normalizeTwoToneColors)(twoToneColor), _normalizeTwoToneColo2 = (0, _slicedToArray22.default)(_normalizeTwoToneColo, 2), primaryColor = _normalizeTwoToneColo2[0], secondaryColor = _normalizeTwoToneColo2[1];
      return React45.createElement("span", (0, _objectSpread22.default)((0, _objectSpread22.default)({
        role: "img",
      ...
      }), React45.createElement(_IconBase.default, {
        icon,
        primaryColor,
        secondaryColor,
        style: svgStyle
...
var require_ArrowLeftOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowLeftOutlined.js"(exports) {
    ...
    var ArrowLeftOutlined2 = function ArrowLeftOutlined3(props, ref) {
      return React45.createElement(_AntdIcon.default, (0, _objectSpread22.default)((0, _objectSpread22.default)({}, props), {}, {
        ref,
        icon: _ArrowLeftOutlined.default
      }));
    };
    ArrowLeftOutlined2.displayName = "ArrowLeftOutlined";
    var _default = React45.forwardRef(ArrowLeftOutlined2);
    exports.default = _default;
  }
});
...
var require_ArrowRightOutlined2 = __commonJS({
  "node_modules/@ant-design/icons/lib/icons/ArrowRightOutlined.js"(exports) {
    ...
    var _default = React45.forwardRef(ArrowRightOutlined2);
    exports.default = _default;
  }
});
...
var require_path_to_regexp2 = __commonJS({
  "node_modules/@umijs/route-utils/es/path-to-regexp.js"(exports) {
    ...
    function match(str, options) {
      var keys = [];
      var re = pathToRegexp5(str, keys, options);
...
var useForm = function(config) {
  ...
  var _e2 = (0, import_react6.useState)(), formResult = _e2[0], setFormResult = _e2[1];
  var version = 3;
...
function useStyle(componentName, styleFn) {
  ...
  var _useContext2 = (0, import_react10.useContext)(ProProvider), _useContext2$hashId = _useContext2.hashId, hashId = _useContext2$hashId === void 0 ? "" : _useContext2$hashId, provideTheme = _useContext2.theme;
  var _useToken = useToken3(), antdToken = _useToken.token;
  var _useContext3 = (0, import_react10.useContext)(config_provider_default.ConfigContext), getPrefixCls = _useContext3.getPrefixCls;
  if (!token2.layout) {
...
var RouteContext = (0, import_react37.createContext)({});
...
var getBackIcon = function getBackIcon2(props) {
  ...
  return direction === "rtl" ? (0, import_jsx_runtime24.jsx)(import_ArrowRightOutlined.default, {}) : (0, import_jsx_runtime24.jsx)(import_ArrowLeftOutlined.default, {});
};
...
var PageHeader = function PageHeader2(props) {
  ...
  var _React$useState = React16.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), compact = _React$useState2[0], updateCompact = _React$useState2[1];
  var onResize = function onResize2(_ref) {
    var width = _ref.width;
    return updateCompact(width < 768);
  };
  var _React$useContext = React16.useContext(config_provider_default.ConfigContext), getPrefixCls = _React$useContext.getPrefixCls, direction = _React$useContext.direction;
  ...
  var className = (0, import_classnames7.default)(prefixCls, hashId, customizeClassName, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-has-breadcrumb"), !!breadcrumbDom), _defineProperty(_classNames, "".concat(prefixCls, "-has-footer"), !!footer), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === "rtl"), _defineProperty(_classNames, "".concat(prefixCls, "-compact"), compact), _defineProperty(_classNames, "".concat(prefixCls, "-wide"), contentWidth === "Fixed" && layout == "top"), _defineProperty(_classNames, "".concat(prefixCls, "-ghost"), true), _classNames));
...
var _map = [576, 768, 992, 1200].map(function(bp2) {
  return "@media (max-width: ".concat(bp2, "px)");
});
...
var MenuItemTooltip = function MenuItemTooltip2(props) {
  var _useState = (0, import_react47.useState)(props.collapsed), _useState2 = _slicedToArray(_useState, 2), collapsed = _useState2[0], setCollapsed = _useState2[1];
  var _useState3 = (0, import_react47.useState)(false), _useState4 = _slicedToArray(_useState3, 2), open = _useState4[0], setOpen = _useState4[1];
  ...
  _defineProperty(this, "getSubMenuOrItem", function(item, level) {
    ...
    if (Array.isArray(children) && children.length > 0) {
      ...
      var defaultTitle = (0, import_jsx_runtime47.jsxs)("div", {
        className: (0, import_classnames13.default)("".concat(baseClassName, "-item-title"), (_this$props3 = _this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.hashId, (_classNames = {}, _defineProperty(_classNames, "".concat(baseClassName, "-item-title-collapsed"), collapsed), _defineProperty(_classNames, "".concat(baseClassName, "-item-title-collapsed-level-").concat(level), collapsed), _defineProperty(_classNames, "".concat(baseClassName, "-group-item-title"), menuType === "group"), _defineProperty(_classNames, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames)),
...
var Tag = import_react60.default.forwardRef(function(_ref, ref) {
  ...
  return (0, import_jsx_runtime66.jsx)("div", _objectSpread2(_objectSpread2({}, rest), {}, {
    ...
    ref,
    children: check ? (0, import_jsx_runtime66.jsx)(CheckOutlined_default, {}) : ""
  }));
});
...
var ProHelpProvide = import_react66.default.createContext({
  dataSource: [],
...
var SelectKeyProvide = import_react68.default.createContext({
  selectedKey: void 0,
...
var t = (e2, o2) => Xt(e2, "name", { value: o2, configurable: true });
var Te = t(({ action: e2, resource: o2, onMutationSuccess: n2, onMutationError: r, autoSave: s, submitOnEnter: l = false, warnWhenUnsavedChanges: i, redirect: d, successNotification: c, errorNotification: y, meta: p, metaData: P, queryMeta: T, mutationMeta: h, liveMode: F, liveParams: u, mutationMode: f, dataProviderName: x, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S2, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, disableServerSideValidation: R = false } = {}) => {
  var ne2, ee;
  let { options: E } = oe(), z2 = (E == null ? void 0 : E.disableServerSideValidation) || R, b = _(), [W] = form_default.useForm(), O = useForm({ form: W }), { form: U } = O, A = fx({ onMutationSuccess: n2 || void 0, onMutationError: async (N, oe2, re) => {
    if (z2) {
      r == null || r(N, oe2, re);
      return;
    }
    let Z = [], ue = U.getFieldsValue();
    Z = Object.keys(Rr(ue)).map((xe) => ({ name: zo(xe), errors: void 0 })), U.setFields(Z);
    let Ne = N == null ? void 0 : N.errors;
    for (let xe in Ne) {
      let ye2 = Ne[xe], Qe = [];
      Array.isArray(ye2) && (Qe = ye2), typeof ye2 == "string" && (Qe = [ye2]), typeof ye2 == "boolean" && ye2 && (Qe = ["Field is not valid."]), typeof ye2 == "object" && "key" in ye2 && (Qe = [b(ye2.key, ye2.message)]), Z.push({ name: zo(xe), errors: Qe });
    }
    U.setFields([...Z]), r == null || r(N, oe2, re);
  }, redirect: d, action: e2, resource: o2, successNotification: c, errorNotification: y, meta: S(p, P), metaData: S(p, P), queryMeta: T, mutationMeta: h, liveMode: F, liveParams: u, mutationMode: f, dataProviderName: x, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S2, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, autoSave: s }), { formLoading: X, onFinish: L, queryResult: I, id: M, onFinishAutoSave: j } = A, { warnWhenUnsavedChanges: _2, setWarnWhen: $ } = Ht(), H = i ?? _2;
  import_react74.default.useEffect(() => {
    U.resetFields();
  }, [(ne2 = I == null ? void 0 : I.data) == null ? void 0 : ne2.data, M]);
  let q2 = t((N) => {
    l && N.key === "Enter" && U.submit();
  }, "onKeyUp"), K = t((N, oe2) => {
    if (N && H && $(true), s != null && s.enabled) {
      $(false);
      let re = (s == null ? void 0 : s.onFinish) ?? ((Z) => Z);
      return j(re(oe2));
    }
    return N;
  }, "onValuesChange"), J = { disabled: X, onClick: () => {
    U.submit();
  } };
  return { form: O.form, formProps: { ...O.formProps, onFinish: (N) => L(N).catch((oe2) => oe2), onKeyUp: q2, onValuesChange: K, initialValues: (ee = I == null ? void 0 : I.data) == null ? void 0 : ee.data }, saveButtonProps: J, ...A, onFinish: async (N) => await L(N ?? O.form.getFieldsValue(true)) };
}, "useForm");
var Jo = t(({ modalProps: e2 = {} } = {}) => {
  let { show: o2, close: n2, visible: r } = gh({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (s) => {
    var l;
    (l = e2.onCancel) == null || l.call(e2, s), n2();
  }, open: r, visible: r }, show: o2, close: n2 };
}, "useModal");
var ot = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  var $, H;
  let [d, c] = import_react75.default.useState(false), y = Ce(), { resource: p, action: P, identifier: T } = G(i.resource), h = ye(), F = me(), u = Dt(), f = i.action ?? P ?? "", x = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), m = typeof e2 == "object" && "key" in e2 ? e2.key : p && f && e2 ? `modal-${T}-${f}` : void 0, C = Te({ meta: { ...m ? { [m]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: a, formProps: S2, id: v, setId: B, formLoading: k, onFinish: g, autoSaveProps: D } = C, R = _(), { warnWhen: E, setWarnWhen: z2 } = Ht(), { show: b, close: W, modalProps: O } = Jo({ modalProps: { open: o2 } }), U = O.open || false, A = { modalProps: O, form: a, formLoading: k, formProps: S2, formResult: void 0, formValues: a.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: g, close: W, open: O.open || false, show: b, visible: U };
  import_react75.default.useEffect(() => {
    var q2, K, J, ne2;
    if (d === false && m) {
      let ee = (K = (q2 = h == null ? void 0 : h.params) == null ? void 0 : q2[m]) == null ? void 0 : K.open;
      if (typeof ee == "boolean" ? ee && b() : typeof ee == "string" && ee === "true" && b(), x) {
        let N = (ne2 = (J = h == null ? void 0 : h.params) == null ? void 0 : J[m]) == null ? void 0 : ne2.id;
        N && (B == null || B(N));
      }
      c(true);
    }
  }, [m, h, x, B]), import_react75.default.useEffect(() => {
    var q2;
    d === true && (U && m ? F({ query: { [m]: { ...(q2 = h == null ? void 0 : h.params) == null ? void 0 : q2[m], open: true, ...x && v && { id: v } } }, options: { keepQuery: true }, type: "replace" }) : m && !U && F({ query: { [m]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [v, U, b, m, x]);
  let X = { disabled: k, loading: k, onClick: () => {
    a.submit();
  } }, L = (0, import_react75.useCallback)(() => {
    if (D.status === "success" && (s != null && s.invalidateOnClose) && y({ id: v, invalidates: l || ["list", "many", "detail"], dataProviderName: i.dataProviderName, resource: T }), E)
      if (window.confirm(R("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        z2(false);
      else
        return;
    B == null || B(void 0), A.close();
  }, [E, D.status]), I = (0, import_react75.useCallback)((q2) => {
    typeof q2 < "u" && (B == null || B(q2)), (!(f === "edit" || f === "clone") || (typeof q2 < "u" || typeof v < "u")) && A.show();
  }, [v]), { visible: M, ...j } = O, _2 = { open: M, ...j };
  return { ...C, ...A, show: I, close: L, open: U, formProps: { ...S2, ...C.formProps, onValuesChange: S2 == null ? void 0 : S2.onValuesChange, onKeyUp: S2 == null ? void 0 : S2.onKeyUp, onFinish: async (q2) => {
    await g(q2), n2 && W(), r && a.resetFields();
  } }, modalProps: { ..._2, width: "1000px", okButtonProps: X, title: R(`${T}.titles.${i.action}`, `${u(`${i.action} ${(($ = p == null ? void 0 : p.meta) == null ? void 0 : $.label) ?? ((H = p == null ? void 0 : p.options) == null ? void 0 : H.label) ?? (p == null ? void 0 : p.label) ?? T}`, "singular")}`), okText: R("buttons.save", "Save"), cancelText: R("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: k };
}, "useModalForm");
var rt = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  let d = Ce(), [c, y] = import_react76.default.useState(false), { visible: p, show: P, close: T } = gh({ defaultVisible: o2 }), { resource: h, action: F, identifier: u } = G(i.resource), f = ye(), x = me(), m = i.action ?? F ?? "", C = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), a = typeof e2 == "object" && "key" in e2 ? e2.key : h && m && e2 ? `drawer-${(h == null ? void 0 : h.identifier) ?? (h == null ? void 0 : h.name)}-${m}` : void 0, S2 = Te({ meta: { ...a ? { [a]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: v, formProps: B, formLoading: k, id: g, setId: D, onFinish: R, autoSaveProps: E } = S2;
  import_react76.default.useEffect(() => {
    var L, I, M, j;
    if (c === false && a) {
      let _2 = (I = (L = f == null ? void 0 : f.params) == null ? void 0 : L[a]) == null ? void 0 : I.open;
      if (typeof _2 == "boolean" ? _2 ? P() : T() : typeof _2 == "string" && _2 === "true" && P(), C) {
        let $ = (j = (M = f == null ? void 0 : f.params) == null ? void 0 : M[a]) == null ? void 0 : j.id;
        $ && (D == null || D($));
      }
      y(true);
    }
  }, [a, f, C, D, c]), import_react76.default.useEffect(() => {
    var L;
    c === true && (p && a ? x({ query: { [a]: { ...(L = f == null ? void 0 : f.params) == null ? void 0 : L[a], open: true, ...C && g && { id: g } } }, options: { keepQuery: true }, type: "replace" }) : a && !p && x({ query: { [a]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [g, p, P, T, a, C, c]);
  let z2 = _(), { warnWhen: b, setWarnWhen: W } = Ht(), O = { disabled: k, onClick: () => {
    v.submit();
  }, loading: k }, U = { recordItemId: g, onSuccess: () => {
    D == null || D(void 0), T();
  } }, A = (0, import_react76.useCallback)(() => {
    if (E.status === "success" && (s != null && s.invalidateOnClose) && d({ id: g, invalidates: l || ["list", "many", "detail"], dataProviderName: i.dataProviderName, resource: u }), b)
      if (window.confirm(z2("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")))
        W(false);
      else
        return;
    T(), D == null || D(void 0);
  }, [b]), X = (0, import_react76.useCallback)((L) => {
    typeof L < "u" && (D == null || D(L)), (!(m === "edit" || m === "clone") || (typeof L < "u" || typeof g < "u")) && P();
  }, [g]);
  return { ...S2, show: X, close: A, formProps: { form: v, ...S2.formProps, onValuesChange: B == null ? void 0 : B.onValuesChange, onKeyUp: B == null ? void 0 : B.onKeyUp, onFinish: async (L) => {
    await R(L), n2 && T(), r && v.resetFields();
  } }, drawerProps: { width: "500px", onClose: A, open: p, forceRender: true }, saveButtonProps: O, deleteButtonProps: U, formLoading: k };
}, "useDrawerForm");
var nt = t((e2 = {}) => {
  let o2 = Te({ ...e2 }), { form: n2, formProps: r } = o2, s = useStepsForm({ isBackValidate: false, form: n2, submit: (l) => {
    var i;
    (i = r == null ? void 0 : r.onFinish) == null || i.call(r, l);
  }, ...e2 });
  return { ...o2, ...s, formLoading: o2.formLoading, formProps: { ...s.formProps, ...o2.formProps, onValuesChange: r == null ? void 0 : r.onValuesChange, onKeyUp: r == null ? void 0 : r.onKeyUp }, saveButtonProps: { ...o2.saveButtonProps, onClick: () => s.submit() } };
}, "useStepsForm");
var Sr = t((e2, o2) => {
  let n2 = kn(e2, o2);
  if (n2)
...
var vr2 = t((e2, o2, n2 = "eq") => Fn(e2, o2, n2), "getDefaultFilter");
var co2 = t((e2) => {
  let o2 = [];
  if (Array.isArray(e2))
    e2.sort((n2, r) => {
      var s, l;
      return (((s = n2.column) == null ? void 0 : s.sorter).multiple ?? 0) < (((l = r.column) == null ? void 0 : l.sorter).multiple ?? 0) ? -1 : 0;
    }).map((n2) => {
      if (n2.field && n2.order) {
        let r = Array.isArray(n2.field) ? n2.field.join(".") : `${n2.field}`;
        o2.push({ field: `${n2.columnKey ?? r}`, order: n2.order.replace("end", "") });
      }
    });
  else if (e2.field && e2.order) {
    let n2 = Array.isArray(e2.field) ? e2.field.join(".") : `${e2.field}`;
    o2.push({ field: `${e2.columnKey ?? n2}`, order: e2.order.replace("end", "") });
  }
  return o2;
}, "mapAntdSorterToCrudSorting");
var fo = t((e2, o2, n2) => {
  let r = [], s = (n2 ?? []).reduce((l, i) => {
    let d = i.key || i.field;
    return { ...l, [d]: i };
  }, {});
  return Object.keys(e2).map((l) => {
    var c, y;
    let i = e2[l], d = ((c = o2.filter((p) => p.operator !== "or").find((p) => p.field === l)) == null ? void 0 : c.operator) || ((y = s[l]) == null ? void 0 : y.operator);
    d !== "or" && d !== "and" && r.push({ field: l, operator: d ?? (Array.isArray(i) ? "in" : "eq"), value: i });
  }), r;
}, "mapAntdFilterToCrudFilter");
var he = t(({ to: e2, element: o2 }) => {
  let { Link: n2 } = ne(), r = q(), s = ft();
  return import_react78.default.createElement(r === "legacy" ? n2 : s, { to: e2, replace: false, onClick: (i) => {
    i.preventDefault();
  } }, o2);
}, "PaginationLink");
var To = t(({ onSearch: e2, initialCurrent: o2, initialPageSize: n2, hasPagination: r = true, pagination: s, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: y, filters: p, sorters: P, syncWithLocation: T, resource: h, successNotification: F, errorNotification: u, queryOptions: f, liveMode: x, onLiveEvent: m, liveParams: C, meta: a, metaData: S2, dataProviderName: v } = {}) => {
  let { tableQueryResult: B, current: k, setCurrent: g, pageSize: D, setPageSize: R, filters: E, setFilters: z2, sorters: b, setSorters: W, sorter: O, setSorter: U, createLinkForSyncWithLocation: A, pageCount: X, overtime: L } = AC({ permanentSorter: i, permanentFilter: c, initialCurrent: o2, initialPageSize: n2, pagination: s, hasPagination: r, filters: p, sorters: P, initialSorter: l, initialFilter: d, syncWithLocation: T, resource: h, defaultSetFilterBehavior: y, successNotification: F, errorNotification: u, queryOptions: f, liveMode: x, onLiveEvent: m, liveParams: C, meta: S(a, S2), metaData: S(a, S2), dataProviderName: v }), I = grid_default.useBreakpoint(), [M] = form_default.useForm(), j = useForm({ form: M }), _2 = Is(x), $ = r === false ? "off" : "server", H = ((s == null ? void 0 : s.mode) ?? $) !== "off", q2 = S(p == null ? void 0 : p.initial, d), { data: K, isFetched: J, isLoading: ne2 } = B, ee = t((re, Z, ue) => {
    ...
    H && (g == null || g(re.current || 1), R == null || R(re.pageSize || 10));
  }, "onChange"), N = t(async (re) => {
    if (e2) {
      let Z = await e2(re);
      z2(Z), H && (g == null || g(1));
    }
  }, "onFinish"), oe2 = t(() => H ? { itemRender: (re, Z, ue) => {
    var Ne;
    let de = A({ pagination: { pageSize: D, current: re }, sorters: b, filters: E });
    if (Z === "page")
      return (0, import_react77.createElement)(he, { to: de, element: `${re}` });
    if (Z === "next" || Z === "prev")
      return (0, import_react77.createElement)(he, { to: de, element: ue });
    if (Z === "jump-next" || Z === "jump-prev") {
      let xe = (Ne = ue == null ? void 0 : ue.props) == null ? void 0 : Ne.children;
      return (0, import_react77.createElement)(he, { to: de, element: import_react77.Children.count(xe) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, xe) : xe });
    }
    return ue;
  }, pageSize: D, current: k, simple: !I.sm, position: I.sm ? ["bottomRight"] : ["bottomCenter"], total: K == null ? void 0 : K.total } : false, "antdPagination");
  return { searchFormProps: { ...j.formProps, onFinish: N }, tableProps: { dataSource: K == null ? void 0 : K.data, loading: _2 === "auto" ? ne2 : !J, onChange: ee, pagination: oe2(), scroll: { x: true } }, tableQueryResult: B, sorters: b, sorter: O, filters: E, setSorters: W, setSorter: U, setFilters: z2, current: k, setCurrent: g, pageSize: D, setPageSize: R, pageCount: X, createLinkForSyncWithLocation: A, overtime: L };
}, "useTable");
var Or = t(({ autoSubmitClose: e2 = true, ...o2 } = {}) => {
  let n2 = To({ ...o2, successNotification: void 0, errorNotification: void 0 }), r = Te({ ...o2, action: "edit", redirect: false }), { id: s, setId: l, saveButtonProps: i } = r, d = { onClick: () => {
    l(void 0);
  } }, c = t((p) => ({ onClick: () => l(p) }), "editButtonProps"), y = t((p) => p === s, "isEditing");
  return { ...n2, ...r, formProps: { ...r.formProps, onFinish: async (p) => {
    let P = await r.onFinish(p);
    return e2 && l(void 0), P;
  } }, saveButtonProps: i, cancelButtonProps: d, editButtonProps: c, isEditing: y };
}, "useEditableTable");
var Rf = t((e2) => {
  let { queryResult: o2, defaultValueQueryResult: n2, onSearch: r, options: s } = RC(e2);
  return { selectProps: { options: s, onSearch: r, loading: n2.isFetching, showSearch: true, filterOption: false }, queryResult: o2, defaultValueQueryResult: n2 };
}, "useSelect");
var zf = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: h, metaData: F, dataProviderName: u }) => {
  let { queryResult: f, options: x } = RC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: S(h, F), metaData: S(h, F), dataProviderName: u });
  return { checkboxGroupProps: { options: x, defaultValue: p }, queryResult: f };
}, "useCheckboxGroup");
var Xf = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: h, metaData: F, dataProviderName: u }) => {
  let { queryResult: f, options: x } = RC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: S(h, F), metaData: S(h, F), dataProviderName: u });
  return { radioGroupProps: { options: x, defaultValue: p }, queryResult: f };
}, "useRadioGroup");
var uy = t(({ resource: e2, resourceName: o2, mapData: n2 = t((p) => p, "mapData"), paparseOptions: r, batchSize: s = Number.MAX_SAFE_INTEGER, onFinish: l, meta: i, metaData: d, dataProviderName: c, onProgress: y } = {}) => {
  let p = _(), { resource: P } = G(e2 ?? o2), { mutationResult: T, isLoading: h, handleChange: F } = lh({ resource: (P == null ? void 0 : P.identifier) ?? (P == null ? void 0 : P.name), mapData: n2, paparseOptions: r, batchSize: s, meta: S(i, d), metaData: S(i, d), dataProviderName: c, onFinish: l, onProgress: y ?? (({ totalAmount: u, processedAmount: f }) => {
    if (u > 0 && f > 0) {
      let x = import_react79.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react79.default.createElement(progress_default, { type: "circle", percent: Math.floor(f / u * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react79.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, p("notifications.importProgress", { processed: f, total: u }, `Importing: ${f}/${u}`)));
      notification_default.open({ description: x, message: null, key: `${P}-import`, duration: 0 }), f >= u, f === u && setTimeout(() => {
        notification_default.destroy(`${P}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: F, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: h }, mutationResult: T, isLoading: h };
}, "useImport");
var Xr = t(({ resource: e2, initialCurrent: o2, initialPageSize: n2, pagination: r, hasPagination: s = true, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: y, filters: p, sorters: P, onSearch: T, queryOptions: h, syncWithLocation: F, successNotification: u, errorNotification: f, liveMode: x, onLiveEvent: m, liveParams: C, meta: a, metaData: S2, dataProviderName: v } = {}) => {
  let { sorters: B, sorter: k, filters: g, current: D, pageSize: R, pageCount: E, setFilters: z2, setCurrent: b, setPageSize: W, setSorter: O, setSorters: U, createLinkForSyncWithLocation: A, tableQueryResult: X, overtime: L } = AC({ resource: e2, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, filters: p, sorters: P, defaultSetFilterBehavior: y, initialCurrent: o2, initialPageSize: n2, queryOptions: h, successNotification: u, errorNotification: f, liveMode: x, onLiveEvent: m, liveParams: C, meta: S(a, S2), metaData: S(a, S2), syncWithLocation: F, dataProviderName: v, pagination: r, hasPagination: s }), I = s === false ? "off" : "server", M = ((r == null ? void 0 : r.mode) ?? I) !== "off", j = grid_default.useBreakpoint(), _2 = Is(x), [$] = form_default.useForm(), { data: H, isFetched: q2, isLoading: K } = X, J = t((N, oe2) => {
    M && (b(N), W(oe2 || 10));
  }, "onChange"), ne2 = t(async (N) => {
    if (T) {
      let oe2 = await T(N);
      return M && (b == null || b(1)), z2(oe2);
    }
  }, "onFinish"), ee = t(() => M ? { itemRender: (N, oe2, re) => {
    var ue;
    let Z = A({ pagination: { pageSize: R, current: N }, sorters: B, filters: g });
    if (oe2 === "page")
      return (0, import_react80.createElement)(he, { to: Z, element: `${N}` });
    if (oe2 === "next" || oe2 === "prev")
      return (0, import_react80.createElement)(he, { to: Z, element: re });
    if (oe2 === "jump-next" || oe2 === "jump-prev") {
      let de = (ue = re == null ? void 0 : re.props) == null ? void 0 : ue.children;
      return (0, import_react80.createElement)(he, { to: Z, element: import_react80.Children.count(de) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, de) : de });
    }
    return re;
  }, pageSize: R, current: D, simple: !j.sm, total: H == null ? void 0 : H.total, onChange: J } : false, "antdPagination");
  return { searchFormProps: { form: $, onFinish: ne2 }, listProps: { dataSource: H == null ? void 0 : H.data, loading: _2 === "auto" ? K : !q2, pagination: ee() }, queryResult: X, filters: g, setFilters: z2, sorter: k, setSorter: O, sorters: B, setSorters: U, current: D, setCurrent: b, pageSize: R, setPageSize: W, pageCount: E, createLinkForSyncWithLocation: A, overtime: L };
}, "useSimpleList");
var Ey = t(() => {
  let [e2, o2] = (0, import_react81.useState)(false), n2 = (0, import_react81.useCallback)((r) => {
    tn(r.fileList).includes(true) ? o2(true) : o2(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: n2 }), [e2]);
}, "useFileUploadState");
var tn = t((e2) => e2.map((o2) => {
  switch (o2.status) {
    case "uploading":
      return true;
    default:
...
var Ie = import_react83.default.createContext({ siderCollapsed: false, mobileSiderOpen: false, setSiderCollapsed: () => {
}, setMobileSiderOpen: () => {
} });
var bo = t(({ children: e2, initialSiderCollapsed: o2 }) => {
  let [n2, r] = (0, import_react83.useState)(o2 ?? false), [s, l] = (0, import_react83.useState)(false);
  return import_react83.default.createElement(Ie.Provider, { value: { siderCollapsed: n2, mobileSiderOpen: s, setSiderCollapsed: r, setMobileSiderOpen: l } }, e2);
}, "ThemedLayoutContextProvider");
var Qy = t(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: n2, setSiderCollapsed: r } = (0, import_react82.useContext)(Ie);
  return { siderVisible: e2, setSiderVisible: n2, drawerSiderVisible: o2, setDrawerSiderVisible: r };
}, "useSiderVisible");
var mt = t(() => {
  let { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: n2, setSiderCollapsed: r } = (0, import_react84.useContext)(Ie);
  return { mobileSiderOpen: e2, siderCollapsed: o2, setMobileSiderOpen: n2, setSiderCollapsed: r };
}, "useThemedLayoutContext");
var xo = t(({ message: e2, cancelMutation: o2, undoableTimeout: n2 }) => import_react86.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react86.default.createElement(progress_default, { type: "circle", percent: (n2 ?? 0) * 20, format: (r) => r && r / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react86.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react86.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: o2, disabled: n2 === 0, icon: import_react86.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var tT = { open: ({ key: e2, message: o2, description: n2, type: r, cancelMutation: s, undoableTimeout: l }) => {
  r === "progress" ? notification_default.open({ key: e2, description: import_react85.default.createElement(xo, { notificationKey: e2, message: o2, cancelMutation: () => {
    s == null || s(), notification_default.destroy(e2 ?? "");
  }, undoableTimeout: l }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : notification_default.open({ key: e2, description: o2, message: n2 ?? null, type: r });
}, close: (e2) => notification_default.destroy(e2) };
var rT = t(() => {
  let { notification: e2 } = app_default.useApp(), o2 = "open" in e2 ? e2 : notification_default;
  return { open: ({ key: r, message: s, description: l, type: i, cancelMutation: d, undoableTimeout: c }) => {
    i === "progress" ? o2.open({ key: r, description: import_react85.default.createElement(xo, { notificationKey: r, message: s, cancelMutation: () => {
      d == null || d(), o2.destroy(r ?? "");
    }, undoableTimeout: c }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : o2.open({ key: r, description: s, message: l ?? null, type: i });
  }, close: (r) => o2.destroy(r) };
}, "useNotificationProvider");
var ct = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var { SubMenu: Dn } = menu_default;
var Po = t(({ Title: e2, render: o2, meta: n2 }) => {
  let [r, s] = (0, import_react88.useState)(false), [l, i] = (0, import_react88.useState)(false), d = to(), c = q(), y = ft(), { warnWhen: p, setWarnWhen: P } = Ht(), { Link: T } = ne(), h = c === "legacy" ? T : y, F = Mn(), u = _(), { menuItems: f, selectedKey: x, defaultOpenKeys: m } = ji({ meta: n2 }), C = grid_default.useBreakpoint(), { hasDashboard: a } = oe(), S2 = Y(), { mutate: v } = vr({ v3LegacyAuthProviderCompatible: !!(S2 != null && S2.isLegacy) }), B = typeof C.lg > "u" ? false : !C.lg, k = e2 ?? F ?? Co, g = t((A, X) => A.map((L) => {
    let { icon: I, label: M, route: j, key: _2, name: $, children: H, parentName: q2, meta: K, options: J } = L;
    if (H.length > 0)
      return import_react88.default.createElement(Cu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(Dn, { key: L.key, icon: I ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: M }, g(H, X)));
    let ne2 = _2 === X, ee = !(S(K == null ? void 0 : K.parent, J == null ? void 0 : J.parent, q2) !== void 0 && H.length === 0);
    return import_react88.default.createElement(Cu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: ne2 ? "bold" : "normal" }, icon: I ?? (ee && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(h, { to: j ?? "" }, M), !r && ne2 && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), D = t(() => {
    p ? window.confirm(u("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (P(false), v()) : v();
  }, "handleLogout"), R = d && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: D, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, u("buttons.logout", "Logout")), E = a ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: x === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(h, { to: "/" }, u("dashboard.title", "Dashboard")), !r && x === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, z2 = g(f, x), b = t(() => o2 ? o2({ dashboard: E, items: z2, logout: R, collapsed: r }) : import_react88.default.createElement(import_react88.default.Fragment, null, E, z2, R), "renderSider"), W = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: x ? [x] : [], defaultOpenKeys: m, mode: "inline", onClick: () => {
    i(false), C.lg || s(true);
  } }, b())), "renderMenu"), O = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: l, onClose: () => i(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(k, { collapsed: false }), W()))), import_react88.default.createElement(button_default, { style: ct, size: "large", onClick: () => i(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, t(() => B ? O() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: r, onCollapse: (A) => s(A), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(k, { collapsed: r }), W()), "renderContent")());
}, "Sider");
var { Text: An } = typography_default;
var Fo = t(() => {
  let e2 = Y(), { data: o2 } = _r({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
  return o2 && (o2.name || o2.avatar) ? import_react89.default.createElement(layout_default.Header, { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react89.default.createElement(space_default, { style: { marginLeft: "8px" } }, (o2 == null ? void 0 : o2.name) && import_react89.default.createElement(An, { style: { color: "white" }, strong: true }, o2.name), (o2 == null ? void 0 : o2.avatar) && import_react89.default.createElement(avatar_default, { src: o2 == null ? void 0 : o2.avatar, alt: o2 == null ? void 0 : o2.name }))) : null;
}, "Header");
var On = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l }) => {
  let i = grid_default.useBreakpoint(), d = n2 ?? Po, c = o2 ?? Fo, y = typeof i.sm > "u" ? true : i.sm;
  return import_react87.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react87.default.createElement(d, { Title: r }), import_react87.default.createElement(layout_default, null, import_react87.default.createElement(c, null), import_react87.default.createElement(layout_default.Content, null, import_react87.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), l && import_react87.default.createElement(l, null)), s && import_react87.default.createElement(s, null)));
}, "Layout");
var Co = t(({ collapsed: e2 }) => {
  let o2 = q(), n2 = ft(), { Link: r } = ne();
  return import_react90.default.createElement(o2 === "legacy" ? r : n2, { to: "/" }, e2 ? import_react90.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" } }, import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine-mini.svg", alt: "Refine", style: { margin: "0 auto", padding: "12px 0", maxHeight: "65.5px" } })) : import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine", style: { width: "200px", padding: "12px 24px" } }));
}, "Title");
var gt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var { SubMenu: ls } = menu_default;
var { useToken: ps } = theme_default;
var vo2 = t(({ Title: e2, render: o2, meta: n2 }) => {
  let { token: r } = ps(), [s, l] = (0, import_react92.useState)(false), [i, d] = (0, import_react92.useState)(false), c = to(), y = q(), p = ft(), { warnWhen: P, setWarnWhen: T } = Ht(), { Link: h } = ne(), F = y === "legacy" ? h : p, u = Mn(), f = _(), { menuItems: x, selectedKey: m, defaultOpenKeys: C } = ji({ meta: n2 }), a = grid_default.useBreakpoint(), { hasDashboard: S2 } = oe(), v = Y(), { mutate: B } = vr({ v3LegacyAuthProviderCompatible: !!(v != null && v.isLegacy) }), k = typeof a.lg > "u" ? false : !a.lg, g = e2 ?? u ?? Lo, D = t((A, X) => A.map((L) => {
    let { icon: I, label: M, route: j, key: _2, name: $, children: H, parentName: q2, meta: K, options: J } = L;
    if (H.length > 0)
      return import_react92.default.createElement(Cu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(ls, { key: L.key, icon: I ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: M }, D(H, X)));
    let ne2 = _2 === X, ee = !(S(K == null ? void 0 : K.parent, J == null ? void 0 : J.parent, q2) !== void 0 && H.length === 0);
    return import_react92.default.createElement(Cu, { key: L.key, resource: $.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.Item, { key: L.key, icon: I ?? (ee && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(F, { to: j ?? "" }, M), !s && ne2 && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), R = t(() => {
    P ? window.confirm(f("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (T(false), B()) : B();
  }, "handleLogout"), E = c && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => R(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, f("buttons.logout", "Logout")), z2 = S2 ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(F, { to: "/" }, f("dashboard.title", "Dashboard")), !s && m === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, b = D(x, m), W = t(() => o2 ? o2({ dashboard: z2, items: b, logout: E, collapsed: s }) : import_react92.default.createElement(import_react92.default.Fragment, null, z2, b, E), "renderSider"), O = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: m ? [m] : [], defaultOpenKeys: C, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    d(false), a.lg || l(true);
  } }, W())), "renderMenu"), U = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: i, onClose: () => d(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated } }, import_react92.default.createElement(g, { collapsed: false })), O()))), import_react92.default.createElement(button_default, { style: gt, size: "large", onClick: () => d(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return k ? U() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` }, collapsible: true, collapsed: s, onCollapse: (A) => l(A), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: r.colorBgElevated } }, s ? import_react92.default.createElement(RightOutlined_default, { style: { color: r.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: r.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: s ? "80px" : "200px", padding: s ? "0" : "0 16px", display: "flex", justifyContent: s ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(g, { collapsed: s })), O());
}, "ThemedSider");
var { Text: Ts } = typography_default;
var { useToken: gs } = theme_default;
var ko = t(() => {
  let { token: e2 } = gs(), o2 = Y(), { data: n2 } = _r({ v3LegacyAuthProviderCompatible: !!(o2 != null && o2.isLegacy) });
  return n2 && (n2.name || n2.avatar) ? import_react93.default.createElement(layout_default.Header, { style: { backgroundColor: e2.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react93.default.createElement(space_default, null, import_react93.default.createElement(space_default, { size: "middle" }, (n2 == null ? void 0 : n2.name) && import_react93.default.createElement(Ts, { strong: true }, n2.name), (n2 == null ? void 0 : n2.avatar) && import_react93.default.createElement(avatar_default, { src: n2 == null ? void 0 : n2.avatar, alt: n2 == null ? void 0 : n2.name })))) : null;
}, "ThemedHeader");
var xs = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l }) => {
  let i = grid_default.useBreakpoint(), d = n2 ?? vo2, c = o2 ?? ko, y = typeof i.sm > "u" ? true : i.sm;
  return import_react91.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react91.default.createElement(d, { Title: r }), import_react91.default.createElement(layout_default, null, import_react91.default.createElement(c, null), import_react91.default.createElement(layout_default.Content, null, import_react91.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), l && import_react91.default.createElement(l, null)), s && import_react91.default.createElement(s, null)));
}, "ThemedLayout");
var { useToken: vs } = theme_default;
var Ls = "refine Project";
var ks = import_react94.default.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react94.default.createElement("path", { d: "M12 9C13.6569 9 15 7.65685 15 6C15 4.34315 13.6569 3 12 3C10.3431 3 9 4.34315 9 6C9 7.65685 10.3431 9 12 9Z", fill: "currentColor" }), import_react94.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12ZM8 6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V18C16 20.2091 14.2091 22 12 22C9.79086 22 8 20.2091 8 18V6Z", fill: "currentColor" }));
var Lo = t(({ collapsed: e2, icon: o2 = ks, text: n2 = Ls, wrapperStyles: r }) => {
  let { token: s } = vs(), l = q(), i = ft(), { Link: d } = ne();
  return import_react94.default.createElement(l === "legacy" ? d : i, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react94.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...r } }, import_react94.default.createElement("div", { style: { height: "24px", width: "24px", color: s.colorPrimary } }, o2), !e2 && import_react94.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, n2)));
}, "ThemedTitle");
var Ft = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var { SubMenu: Ys } = menu_default;
var { useToken: _s } = theme_default;
var wo = t(({ Title: e2, render: o2, meta: n2, fixed: r, activeItemDisabled: s = false }) => {
  let { token: l } = _s(), { siderCollapsed: i, setSiderCollapsed: d, mobileSiderOpen: c, setMobileSiderOpen: y } = mt(), p = to(), P = q(), T = ft(), { warnWhen: h, setWarnWhen: F } = Ht(), { Link: u } = ne(), f = P === "legacy" ? u : T, x = Mn(), m = _(), { menuItems: C, selectedKey: a, defaultOpenKeys: S2 } = ji({ meta: n2 }), v = grid_default.useBreakpoint(), { hasDashboard: B } = oe(), k = Y(), { mutate: g } = vr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof v.lg > "u" ? false : !v.lg, R = e2 ?? x ?? ce, E = t((I, M) => I.map((j) => {
    let { icon: _2, label: $, route: H, key: q2, name: K, children: J, parentName: ne2, meta: ee, options: N } = j;
    if (J.length > 0)
      return import_react96.default.createElement(Cu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(Ys, { key: j.key, icon: _2 ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: $ }, E(J, M)));
    let oe2 = q2 === M, re = !(S(ee == null ? void 0 : ee.parent, N == null ? void 0 : N.parent, ne2) !== void 0 && J.length === 0), Z = s && oe2 ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(Cu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(menu_default.Item, { key: j.key, icon: _2 ?? (re && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: Z }, import_react96.default.createElement(f, { to: H ?? "", style: Z }, $), !i && oe2 && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), z2 = t(() => {
    h ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (F(false), g()) : g();
  }, "handleLogout"), b = p && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => z2(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), W = B ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(f, { to: "/" }, m("dashboard.title", "Dashboard")), !i && a === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, O = E(C, a), U = t(() => o2 ? o2({ dashboard: W, items: O, logout: b, collapsed: i }) : import_react96.default.createElement(import_react96.default.Fragment, null, W, O, b), "renderSider"), A = t(() => import_react96.default.createElement(menu_default, { selectedKeys: a ? [a] : [], defaultOpenKeys: S2, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, U()), "renderMenu"), X = t(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: c, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: l.colorBgContainer, borderRight: `1px solid ${l.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: l.colorBgElevated } }, import_react96.default.createElement(R, { collapsed: false })), A()))), import_react96.default.createElement(button_default, { style: Ft, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (D)
    return X();
  let L = { backgroundColor: l.colorBgContainer, borderRight: `1px solid ${l.colorBgElevated}` };
  return r && (L.position = "fixed", L.top = 0, L.height = "100vh", L.zIndex = 999), import_react96.default.createElement(import_react96.default.Fragment, null, r && import_react96.default.createElement("div", { style: { width: i ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: L, collapsible: true, collapsed: i, onCollapse: (I, M) => {
    M === "clickTrigger" && d(I);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react96.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: l.colorBgElevated } }, i ? import_react96.default.createElement(RightOutlined_default, { style: { color: l.colorPrimary } }) : import_react96.default.createElement(LeftOutlined_default, { style: { color: l.colorPrimary } })) }, import_react96.default.createElement("div", { style: { width: i ? "80px" : "200px", padding: i ? "0" : "0 16px", display: "flex", justifyContent: i ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: l.colorBgElevated, fontSize: "14px" } }, import_react96.default.createElement(R, { collapsed: i })), A()));
}, "ThemedSiderV2");
var { Text: na } = typography_default;
var { useToken: sa } = theme_default;
var Ro = t(({ isSticky: e2, sticky: o2 }) => {
  let { token: n2 } = sa(), r = Y(), { data: s } = _r({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) });
  if (!(s && (s.name || s.avatar)))
    return null;
  let i = { backgroundColor: n2.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" };
  return S(o2, e2) && (i.position = "sticky", i.top = 0, i.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: i }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (s == null ? void 0 : s.name) && import_react97.default.createElement(na, { strong: true }, s.name), (s == null ? void 0 : s.avatar) && import_react97.default.createElement(avatar_default, { src: s == null ? void 0 : s.avatar, alt: s == null ? void 0 : s.name }))));
}, "ThemedHeaderV2");
var ia = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l, initialSiderCollapsed: i }) => {
  let d = grid_default.useBreakpoint(), c = n2 ?? wo, y = o2 ?? Ro, p = typeof d.sm > "u" ? true : d.sm, P = !!c({ Title: r });
  return import_react95.default.createElement(bo, { initialSiderCollapsed: i }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: P }, import_react95.default.createElement(c, { Title: r }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: p ? 24 : 12 } }, e2), l && import_react95.default.createElement(l, null)), s && import_react95.default.createElement(s, null))));
}, "ThemedLayoutV2");
var { useToken: fa } = theme_default;
var ya = "refine Project";
var Ta = import_react98.default.createElement("svg", { width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react98.default.createElement("path", { d: "M12 9C13.6569 9 15 7.65685 15 6C15 4.34315 13.6569 3 12 3C10.3431 3 9 4.34315 9 6C9 7.65685 10.3431 9 12 9Z", fill: "currentColor" }), import_react98.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M24 12C24 18.6274 18.6274 24 12 24C5.37258 24 0 18.6274 0 12C0 5.37258 5.37258 0 12 0C18.6274 0 24 5.37258 24 12ZM8 6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V18C16 20.2091 14.2091 22 12 22C9.79086 22 8 20.2091 8 18V6Z", fill: "currentColor" }));
var ce = t(({ collapsed: e2, icon: o2 = Ta, text: n2 = ya, wrapperStyles: r }) => {
  let { token: s } = fa(), l = q(), i = ft(), { Link: d } = ne();
  return import_react98.default.createElement(l === "legacy" ? d : i, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react98.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...r } }, import_react98.default.createElement("div", { style: { height: "24px", width: "24px", color: s.colorPrimary } }, o2), !e2 && import_react98.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, n2)));
}, "ThemedTitleV2");
var Vo = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  let c = (0, import_react99.useContext)(ut), y = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, p = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, P = _(), T = q(), h = ft(), { Link: F } = ne(), u = T === "legacy" ? F : h, { createUrl: f } = le(), { resource: x } = G(e2 ?? o2), { data: m } = Ks({ resource: x == null ? void 0 : x.name, action: "create", queryOptions: { enabled: y }, params: { resource: x } }), C = t(() => m != null && m.can ? "" : m != null && m.reason ? m.reason : P("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), a = x ? f(x, s) : "";
  return y && p && !(m != null && m.can) ? null : import_react99.default.createElement(u, { to: a, replace: false, onClick: (S2) => {
    if ((m == null ? void 0 : m.can) === false) {
      S2.preventDefault();
      return;
    }
    i && (S2.preventDefault(), i(S2));
  } }, import_react99.default.createElement(button_default, { icon: import_react99.default.createElement(PlusSquareOutlined_default, null), disabled: (m == null ? void 0 : m.can) === false, title: C(), className: n.CreateButton, type: "primary", ...d }, !n2 && (l ?? P("buttons.create", "Create"))));
}, "CreateButton");
var Ho = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react100.useContext)(ut), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, T = _(), h = q(), F = ft(), { Link: u } = ne(), f = h === "legacy" ? u : F, { editUrl: x } = le(), { id: m, resource: C } = G(e2 ?? o2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "edit", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : T("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 ?? m) ? x(C, n2 ?? m, l) : "";
  return p && P && !(a != null && a.can) ? null : import_react100.default.createElement(f, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.EditButton, ...c }, !r && (i ?? T("buttons.edit", "Edit"))));
}, "EditButton");
var Ye = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, onSuccess: r, mutationMode: s, children: l, successNotification: i, errorNotification: d, hideText: c = false, accessControl: y, metaData: p, meta: P, dataProviderName: T, confirmTitle: h, confirmOkText: F, confirmCancelText: u, invalidates: f, ...x }) => {
  let m = (0, import_react101.useContext)(ut), C = (y == null ? void 0 : y.enabled) ?? m.options.buttons.enableAccessControl, a = (y == null ? void 0 : y.hideIfUnauthorized) ?? m.options.buttons.hideIfUnauthorized, S2 = _(), { id: v, resource: B, identifier: k } = G(e2 ?? o2), { mutationMode: g } = ze(), D = s ?? g, { mutate: R, isLoading: E, variables: z2 } = ca(), { data: b } = Ks({ resource: B == null ? void 0 : B.name, action: "delete", params: { id: n2 ?? v, resource: B }, queryOptions: { enabled: C } }), W = t(() => b != null && b.can ? "" : b != null && b.reason ? b.reason : S2("buttons.notAccessTitle", "You don't have permission to access"), "disabledTitle"), { setWarnWhen: O } = Ht();
  return C && a && !(b != null && b.can) ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: F ?? S2("buttons.delete", "Delete"), cancelText: u ?? S2("buttons.cancel", "Cancel"), okType: "danger", title: h ?? S2("buttons.confirm", "Are you sure?"), okButtonProps: { disabled: E }, onConfirm: () => {
    (n2 ?? v) && k && (O(false), R({ id: n2 ?? v ?? "", resource: k, mutationMode: D, successNotification: i, errorNotification: d, meta: S(P, p), metaData: S(P, p), dataProviderName: T, invalidates: f }, { onSuccess: (U) => {
      r && r(U);
    } }));
  }, disabled: typeof (x == null ? void 0 : x.disabled) < "u" ? x.disabled : (b == null ? void 0 : b.can) === false }, import_react101.default.createElement(button_default, { danger: true, loading: (n2 ?? v) === (z2 == null ? void 0 : z2.id) && E, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: W(), disabled: (b == null ? void 0 : b.can) === false, className: n.DeleteButton, ...x }, !c && (l ?? S2("buttons.delete", "Delete"))));
}, "DeleteButton");
var _e = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, dataProviderName: s, children: l, onClick: i, meta: d, metaData: c, ...y }) => {
  let p = _(), P = useQueryClient(), T = Ce(), { resources: h, identifier: F, id: u } = G(e2 ?? o2), f = !!P.isFetching({ queryKey: vo(F, z(F, s, h)).detail(n2 ?? u) }), x = t(() => {
    T({ id: n2 ?? u, invalidates: ["detail"], dataProviderName: s, resource: F });
  }, "handleInvalidate");
  return import_react102.default.createElement(button_default, { onClick: (m) => {
    i ? i(m) : x();
  }, icon: import_react102.default.createElement(RedoOutlined_default, { spin: f }), className: n.RefreshButton, ...y }, !r && (l ?? p("buttons.refresh", "Refresh")));
}, "RefreshButton");
var Si = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react103.useContext)(ut), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, { showUrl: T } = le(), h = q(), F = ft(), { Link: u } = ne(), f = h === "legacy" ? u : F, x = _(), { id: m, resource: C } = G(e2 ?? o2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "show", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : x("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? T(C, n2 ?? m, l) : "";
  return p && P && !(a != null && a.can) ? null : import_react103.default.createElement(f, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.ShowButton, ...c }, !r && (i ?? x("buttons.show", "Show"))));
}, "ShowButton");
var Ze = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  var B;
  let c = (0, import_react104.useContext)(ut), y = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, p = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, { listUrl: P } = le(), T = q(), h = ft(), { Link: F } = ne(), u = Dt(), f = T === "legacy" ? F : h, x = _(), { resource: m, identifier: C } = G(e2 ?? o2), { data: a } = Ks({ resource: m == null ? void 0 : m.name, action: "list", queryOptions: { enabled: y }, params: { resource: m } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : x("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = m ? P(m, s) : "";
  return y && p && !(a != null && a.can) ? null : import_react104.default.createElement(f, { to: v, replace: false, onClick: (k) => {
    if ((a == null ? void 0 : a.can) === false) {
      k.preventDefault();
      return;
    }
    i && (k.preventDefault(), i(k));
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(BarsOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.ListButton, ...d }, !n2 && (l ?? x(`${C ?? e2 ?? o2}.titles.list`, u(((B = m == null ? void 0 : m.meta) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? C ?? S(e2, o2), "plural")))));
}, "ListButton");
var Gi = t(({ hideText: e2 = false, children: o2, ...n2 }) => {
  let r = _();
  return import_react105.default.createElement(button_default, { type: "default", icon: import_react105.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...n2 }, !e2 && (o2 ?? r("buttons.export", "Export")));
}, "ExportButton");
var Xe = t(({ hideText: e2 = false, children: o2, ...n2 }) => {
  let r = _();
  return import_react106.default.createElement(button_default, { type: "primary", icon: import_react106.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...n2 }, !e2 && (o2 ?? r("buttons.save", "Save")));
}, "SaveButton");
var dl = t(({ resourceNameOrRouteName: e2, resource: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react107.useContext)(ut), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, { cloneUrl: T } = le(), h = q(), F = ft(), { Link: u } = ne(), f = h === "legacy" ? u : F, x = _(), { id: m, resource: C } = G(o2 ?? e2), { data: a } = Ks({ resource: C == null ? void 0 : C.name, action: "create", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : x("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? T(C, n2 ?? m, l) : "";
  return p && P && !(a != null && a.can) ? null : import_react107.default.createElement(f, { to: v, replace: false, onClick: (B) => {
    if ((a == null ? void 0 : a.can) === false) {
      B.preventDefault();
      return;
    }
    d && (B.preventDefault(), d(B));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.CloneButton, ...c }, !r && (i ?? x("buttons.clone", "Clone"))));
}, "CloneButton");
var bl = t(({ uploadProps: e2, buttonProps: o2, hideText: n2 = false, children: r }) => {
  let s = _();
  return import_react108.default.createElement(upload_default, { ...e2 }, import_react108.default.createElement(button_default, { icon: import_react108.default.createElement(ImportOutlined_default, null), className: n.ImportButton, ...o2 }, !n2 && (r ?? s("buttons.import", "Import"))));
}, "ImportButton");
var Sl = t(({ canCreate: e2, title: o2, children: n2, createButtonProps: r, resource: s, wrapperProps: l, contentProps: i, headerProps: d, breadcrumb: c, headerButtonProps: y, headerButtons: p }) => {
  var S2, v;
  let P = _(), { options: { breadcrumb: T } = {} } = oe(), h = q(), F = Dt(), { resource: u, identifier: f } = G(s), x = e2 ?? (((u == null ? void 0 : u.canCreate) ?? !!(u != null && u.create)) || r), m = typeof c > "u" ? T : c, C = x ? { size: "middle", resource: h === "legacy" ? u == null ? void 0 : u.route : f, ...r } : void 0, a = x ? import_react109.default.createElement(Vo, { ...C }) : null;
  return import_react109.default.createElement("div", { ...l ?? {} }, import_react109.default.createElement(Se, { ghost: false, title: o2 ?? P(`${f}.titles.list`, F(((S2 = u == null ? void 0 : u.meta) == null ? void 0 : S2.label) ?? ((v = u == null ? void 0 : u.options) == null ? void 0 : v.label) ?? (u == null ? void 0 : u.label) ?? f, "plural")), extra: p ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof p == "function" ? p({ defaultButtons: a, createButtonProps: C }) : p) : a, breadcrumb: typeof m < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, m) ?? void 0 : import_react109.default.createElement(Be, null), ...d ?? {} }, import_react109.default.createElement("div", { ...i ?? {} }, n2)));
}, "List");
var Vl = t(({ title: e2, saveButtonProps: o2, children: n2, resource: r, isLoading: s = false, breadcrumb: l, wrapperProps: i, headerProps: d, contentProps: c, headerButtonProps: y, headerButtons: p, footerButtonProps: P, footerButtons: T, goBack: h }) => {
  var D, R;
  let F = _(), { options: { breadcrumb: u } = {} } = oe(), f = q(), x = co(), { goBack: m } = le(), C = Dt(), { resource: a, action: S2, identifier: v } = G(r), B = typeof l > "u" ? u : l, k = { ...s ? { disabled: true } : {}, ...o2, htmlType: "submit" }, g = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...k }));
  return import_react110.default.createElement("div", { ...i ?? {} }, import_react110.default.createElement(Se, { ghost: false, backIcon: h, onBack: S2 !== "list" || typeof S2 < "u" ? f === "legacy" ? m : x : void 0, title: e2 ?? F(`${v}.titles.create`, `Create ${C(((D = a == null ? void 0 : a.meta) == null ? void 0 : D.label) ?? ((R = a == null ? void 0 : a.options) == null ? void 0 : R.label) ?? (a == null ? void 0 : a.label) ?? v, "singular")}`), breadcrumb: typeof B < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, B) ?? void 0 : import_react110.default.createElement(Be, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: null }) : p : null), ...d ?? {} }, import_react110.default.createElement(spin_default, { spinning: s }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...P ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: g, saveButtonProps: k }) : T : g)], ...c ?? {} }, n2))));
}, "Create");
var ql = t(({ title: e2, saveButtonProps: o2, mutationMode: n2, recordItemId: r, children: s, deleteButtonProps: l, canDelete: i, resource: d, isLoading: c = false, dataProviderName: y, breadcrumb: p, wrapperProps: P, headerProps: T, contentProps: h, headerButtonProps: F, headerButtons: u, footerButtonProps: f, footerButtons: x, goBack: m, autoSaveProps: C }) => {
  var J, ne2, ee;
  let a = _(), { options: { breadcrumb: S2 } = {} } = oe(), { mutationMode: v } = ze(), B = n2 ?? v, k = q(), g = co(), D = me(), { goBack: R, list: E } = le(), z2 = Dt(), { resource: b, action: W, id: O, identifier: U } = G(d), A = Mi({ resource: b, action: "list" }), X = r ?? O, L = typeof p > "u" ? S2 : p, I = (b == null ? void 0 : b.list) && !r, M = i ?? ((((J = b == null ? void 0 : b.meta) == null ? void 0 : J.canDelete) ?? (b == null ? void 0 : b.canDelete)) || l), j = I ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U } : void 0, _2 = { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, recordItemId: X, dataProviderName: y }, $ = M ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, mutationMode: B, onSuccess: () => {
    k === "legacy" ? E((b == null ? void 0 : b.route) ?? (b == null ? void 0 : b.name) ?? "") : D({ to: A });
  }, recordItemId: X, dataProviderName: y, ...l } : void 0, H = { ...c ? { disabled: true } : {}, ...o2 }, q2 = import_react111.default.createElement(import_react111.default.Fragment, null, C && import_react111.default.createElement(It, { ...C }), I && import_react111.default.createElement(Ze, { ...j }), import_react111.default.createElement(_e, { ..._2 })), K = import_react111.default.createElement(import_react111.default.Fragment, null, M && import_react111.default.createElement(Ye, { ...$ }), import_react111.default.createElement(Xe, { ...H }));
  return import_react111.default.createElement("div", { ...P ?? {} }, import_react111.default.createElement(Se, { ghost: false, backIcon: m, onBack: W !== "list" && typeof W < "u" ? k === "legacy" ? R : g : void 0, title: e2 ?? a(`${U}.titles.edit`, `Edit ${z2(((ne2 = b == null ? void 0 : b.meta) == null ? void 0 : ne2.label) ?? ((ee = b == null ? void 0 : b.options) == null ? void 0 : ee.label) ?? (b == null ? void 0 : b.label) ?? U, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...F ?? {} }, u ? typeof u == "function" ? u({ defaultButtons: q2, listButtonProps: j, refreshButtonProps: _2 }) : u : q2), breadcrumb: typeof L < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, L) ?? void 0 : import_react111.default.createElement(Be, null), ...T ?? {} }, import_react111.default.createElement(spin_default, { spinning: c }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...f ?? {} }, x ? typeof x == "function" ? x({ defaultButtons: K, deleteButtonProps: $, saveButtonProps: H }) : x : K)], ...h ?? {} }, s))));
}, "Edit");
var ap = t(({ title: e2, canEdit: o2, canDelete: n2, isLoading: r = false, children: s, resource: l, recordItemId: i, dataProviderName: d, breadcrumb: c, contentProps: y, headerProps: p, wrapperProps: P, headerButtons: T, footerButtons: h, footerButtonProps: F, headerButtonProps: u, goBack: f }) => {
  var _2, $, H;
  let x = _(), { options: { breadcrumb: m } = {} } = oe(), C = q(), a = co(), S2 = me(), { goBack: v, list: B } = le(), k = Dt(), { resource: g, action: D, id: R, identifier: E } = G(l), z2 = Mi({ resource: g, action: "list" }), b = i ?? R, W = typeof c > "u" ? m : c, O = (g == null ? void 0 : g.list) && !i, U = n2 ?? ((_2 = g == null ? void 0 : g.meta) == null ? void 0 : _2.canDelete) ?? (g == null ? void 0 : g.canDelete), A = o2 ?? (g == null ? void 0 : g.canEdit) ?? !!(g != null && g.edit), X = O ? { resource: C === "legacy" ? g == null ? void 0 : g.route : E } : void 0, L = A ? { ...r ? { disabled: true } : {}, type: "primary", resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b } : void 0, I = U ? { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, onSuccess: () => {
    C === "legacy" ? B((g == null ? void 0 : g.route) ?? (g == null ? void 0 : g.name) ?? "") : S2({ to: z2 });
  }, dataProviderName: d } : void 0, M = { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, dataProviderName: d }, j = import_react112.default.createElement(import_react112.default.Fragment, null, O && import_react112.default.createElement(Ze, { ...X }), A && import_react112.default.createElement(Ho, { ...L }), U && import_react112.default.createElement(Ye, { ...I }), import_react112.default.createElement(_e, { ...M }));
  return import_react112.default.createElement("div", { ...P ?? {} }, import_react112.default.createElement(Se, { ghost: false, backIcon: f, onBack: D !== "list" && typeof D < "u" ? C === "legacy" ? v : a : void 0, title: e2 ?? x(`${E}.titles.show`, `Show ${k((($ = g == null ? void 0 : g.meta) == null ? void 0 : $.label) ?? ((H = g == null ? void 0 : g.options) == null ? void 0 : H.label) ?? (g == null ? void 0 : g.label) ?? E, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...u ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: j, deleteButtonProps: I, editButtonProps: L, listButtonProps: X, refreshButtonProps: M }) : T : j), breadcrumb: typeof W < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, W) ?? void 0 : import_react112.default.createElement(Be, null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: r }, import_react112.default.createElement(card_default, { bordered: false, actions: h ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...F }, typeof h == "function" ? h({ defaultButtons: null }) : h)] : void 0, ...y ?? {} }, s))));
}, "Show");
var { Text: pp } = typography_default;
var up = t(({ value: e2, ...o2 }) => import_react113.default.createElement(pp, { ...o2 }, e2), "TextField");
var cp = t(({ value: e2, ...o2 }) => import_react114.default.createElement(tag_default, { ...o2 }, e2 == null ? void 0 : e2.toString()), "TagField");
var { Link: Tp } = typography_default;
var gp = t(({ value: e2, ...o2 }) => import_react115.default.createElement(Tp, { href: `mailto:${e2}`, ...o2 }, e2), "EmailField");
var hp = t(({ value: e2, imageTitle: o2, ...n2 }) => import_react116.default.createElement(image_default, { ...n2, src: e2, title: o2 }), "ImageField");
var Bp = t(({ value: e2, valueLabelTrue: o2 = "true", valueLabelFalse: n2 = "false", trueIcon: r = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: s = import_react117.default.createElement(CloseOutlined_default, null), ...l }) => import_react117.default.createElement(tooltip_default, { title: e2 ? o2 : n2, ...l }, e2 ? import_react117.default.createElement("span", null, r) : import_react117.default.createElement("span", null, s)), "BooleanField");
var kp = t(({ value: e2, locales: o2, format: n2 = "L", ...r }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let s = import_dayjs5.default.locale(), { Text: l } = typography_default;
  return import_react118.default.createElement(l, { ...r }, (0, import_dayjs5.default)(e2).locale(o2 || s).format(n2));
}, "DateField");
var Ep = t(({ title: e2, src: o2, ...n2 }) => import_react119.default.createElement(jo, { value: o2, title: e2, ...n2 }, e2 ?? o2), "FileField");
var { Link: Up } = typography_default;
var jo = t(({ children: e2, value: o2, ...n2 }) => import_react120.default.createElement(Up, { href: o2, ...n2 }, e2 ?? o2), "UrlField");
var { Text: Ap } = typography_default;
function Hp() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
t(Hp, "toLocaleStringSupportsOptions");
var Op = t(({ value: e2, locale: o2, options: n2, ...r }) => {
  let s = Number(e2);
  return import_react121.default.createElement(Ap, { ...r }, Hp() ? s.toLocaleString(o2, n2) : s);
}, "NumberField");
var zp = t(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var $p = t((e2) => {
  let { setSelectedKeys: o2, confirm: n2, clearFilters: r, mapValue: s, selectedKeys: l, children: i } = e2, [d, c] = (0, import_react123.useState)(l), y = _(), p = t(() => {
    r && (c([]), r());
  }, "clearFilter"), P = t(() => {
    let u = T(d), f;
    typeof u == "number" ? f = `${u}` : import_dayjs6.default.isDayjs(u) ? f = [u.toISOString()] : f = u, o2(f), n2 == null || n2();
  }, "onFilter"), T = t((u) => s ? s(u) : u, "mappedValue"), h = t((u) => {
    if (typeof u == "object") {
      if (Array.isArray(u)) {
        let a = T(u);
        return c(a), o2(a);
      }
      let x = !u || !u.target || import_dayjs6.default.isDayjs(u) ? { target: { value: u } } : u, { target: m } = x, C = T(m.value);
      c(C);
      return;
    }
    let f = T(u);
    c(f);
  }, "onChange"), F = import_react123.default.Children.map(i, (u) => import_react123.default.isValidElement(u) ? import_react123.default.cloneElement(u, { onChange: h, value: T(d) }) : u);
  return import_react123.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react123.default.createElement("div", { style: { marginBottom: 15 } }, F), import_react123.default.createElement(space_default, null, import_react123.default.createElement(button_default, { type: "primary", size: "small", onClick: () => P() }, import_react123.default.createElement(FilterOutlined_default, null), " ", y("buttons.filter", "Filter")), import_react123.default.createElement(button_default, { danger: true, size: "small", onClick: () => p() }, y("buttons.clear", "Clear"))));
}, "FilterDropdown");
var { Text: au } = typography_default;
var iu = t(() => {
  let [e2, o2] = (0, import_react124.useState)(), n2 = _(), { push: r } = le(), s = me(), l = q(), { resource: i, action: d } = G();
  return (0, import_react124.useEffect)(() => {
    i && d && o2(n2("pages.error.info", { action: d, resource: i == null ? void 0 : i.name }, `You may have forgotten to add the "${d}" component to "${i == null ? void 0 : i.name}" resource.`));
  }, [i, d]), import_react124.default.createElement(result_default, { status: "404", title: "404", extra: import_react124.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react124.default.createElement(space_default, null, import_react124.default.createElement(au, null, n2("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react124.default.createElement(tooltip_default, { title: e2 }, import_react124.default.createElement(InfoCircleOutlined_default, {}))), import_react124.default.createElement(button_default, { type: "primary", onClick: () => {
    l === "legacy" ? r("/") : s({ to: "/" });
  } }, n2("pages.error.backHome", "Back Home"))) });
}, "ErrorComponent");
var Mt = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var Nt = { maxWidth: "408px", margin: "auto" };
var Qt = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var zt = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var { Text: bu, Title: xu } = typography_default;
var hu = t(() => {
  let [e2] = form_default.useForm(), o2 = _(), n2 = Y(), { mutate: r, isLoading: s } = Gt({ v3LegacyAuthProviderCompatible: !!(n2 != null && n2.isLegacy) }), l = import_react125.default.createElement(xu, { level: 3, style: Qt }, o2("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: Mt }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Nt }, import_react125.default.createElement("div", { style: zt }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: l, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (i) => {
    r(i);
  }, requiredMark: false, initialValues: { remember: false } }, import_react125.default.createElement(form_default.Item, { name: "username", label: o2("pages.login.username", "Username"), rules: [{ required: true }] }, import_react125.default.createElement(input_default, { size: "large", placeholder: o2("pages.login.username", "Username") })), import_react125.default.createElement(form_default.Item, { name: "password", label: o2("pages.login.password", "Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react125.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react125.default.createElement("div", { style: { marginBottom: "12px" } }, import_react125.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react125.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, o2("pages.login.remember", "Remember me"))), import_react125.default.createElement("a", { style: { float: "right", fontSize: "12px" }, href: "#" }, o2("pages.login.forgotPassword", "Forgot password?"))), import_react125.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: s, block: true }, o2("pages.login.signin", "Sign in"))), import_react125.default.createElement("div", { style: { marginTop: 8 } }, import_react125.default.createElement(bu, { style: { fontSize: 12 } }, o2("pages.login.noAccount", "Don’t have an account?"), " ", import_react125.default.createElement("a", { href: "#", style: { fontWeight: "bold" } }, o2("pages.login.signup", "Sign up")))))))));
}, "LoginPage");
var Ae = { root: { height: "100vh", backgroundImage: "url('https://refine.ams3.cdn.digitaloceanspaces.com/login-background/background.png')", backgroundSize: "cover", backgroundColor: "#331049" }, title: { color: "white", fontWeight: 800, fontSize: "64px", marginBottom: "8px" }, p1: { color: "white", marginBottom: 0, fontSize: "20px", fontWeight: "bold" }, p2: { color: "white", fontSize: "20px" }, code: { backgroundColor: "white", color: "#331049" } };
var { Title: ku } = typography_default;
var Du = t(() => se.createElement(row_default, { align: "middle", justify: "center", style: Ae.root }, se.createElement(col_default, { style: { textAlign: "center" } }, se.createElement("img", { style: { marginBottom: "48px" }, src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" }), se.createElement(ku, { style: Ae.title }, "Welcome on board"), se.createElement("p", { style: Ae.p1 }, "Your configuration is completed."), se.createElement("p", { style: Ae.p2 }, "Now you can get started by adding your resources to the", " ", se.createElement("code", { style: Ae.code }, "resources"), " property of", " ", se.createElement("code", { style: Ae.code }, "<Refine>")), se.createElement(space_default, { size: "large", wrap: true, style: { marginTop: "70px", justifyContent: "center" } }, se.createElement("a", { href: "https://refine.dev", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(ReadOutlined_default, null) }, "Documentation")), se.createElement("a", { href: "https://refine.dev/examples", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(FolderOutlined_default, null) }, "Examples")), se.createElement("a", { href: "https://discord.gg/refine", target: "_blank", rel: "noreferrer" }, se.createElement(button_default, { size: "large", icon: se.createElement(TeamOutlined_default, null) }, "Community"))))), "ReadyPage");
var Ru = t(() => import_react126.default.createElement(ru, null), "WelcomePage");
var ve = {};
var Le = { maxWidth: "400px", margin: "auto", padding: "32px", boxShadow: "0px 2px 4px rgba(0, 0, 0, 0.02), 0px 1px 6px -1px rgba(0, 0, 0, 0.02), 0px 1px 2px rgba(0, 0, 0, 0.03)" };
var ke = { borderBottom: 0, padding: 0 };
var De = { padding: 0, marginTop: "32px" };
var Ee = { textAlign: "center", marginBottom: 0, fontSize: "24px", lineHeight: "32px", fontWeight: 700, overflowWrap: "break-word", hyphens: "manual", textOverflow: "unset", whiteSpace: "pre-wrap" };
var { Text: Gt2, Title: $u } = typography_default;
var { useToken: qu } = theme_default;
var Go = t(({ providers: e2, registerLink: o2, forgotPasswordLink: n2, rememberMe: r, contentProps: s, wrapperProps: l, renderContent: i, formProps: d, title: c, hideForm: y }) => {
  let { token: p } = qu(), [P] = form_default.useForm(), T = _(), h = q(), F = ft(), { Link: u } = ne(), f = h === "legacy" ? u : F, x = Y(), { mutate: m, isLoading: C } = Gt({ v3LegacyAuthProviderCompatible: !!(x != null && x.isLegacy) }), a = c === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, c ?? import_react128.default.createElement(ce, { collapsed: false })), S2 = import_react128.default.createElement($u, { level: 3, style: { color: p.colorPrimaryTextHover, ...Ee } }, T("pages.login.title", "Sign in to your account")), v = t(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((k) => import_react128.default.createElement(button_default, { key: k.name, type: "default", block: true, icon: k.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => m({ providerName: k.name }) }, k.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(Gt2, { style: { color: p.colorTextLabel } }, T("pages.login.divider", "or")))) : null, "renderProviders"), B = import_react128.default.createElement(card_default, { title: S2, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: p.colorBgElevated }, ...s ?? {} }, v(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: P, onFinish: (k) => m(k), requiredMark: false, initialValues: { remember: false }, ...d }, import_react128.default.createElement(form_default.Item, { name: "email", label: T("pages.login.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: T("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: T("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: T("pages.login.fields.password", "Password"), rules: [{ required: true }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, r ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, T("pages.login.buttons.rememberMe", "Remember me"))), n2 ?? import_react128.default.createElement(f, { style: { color: p.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, T("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: C, block: true }, T("pages.login.signin", "Sign in")))), o2 ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(Gt2, { style: { fontSize: 12 } }, T("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(f, { to: "/register", style: { fontWeight: "bold", color: p.colorPrimaryTextHover } }, T("pages.login.signup", "Sign up")))));
  return import_react128.default.createElement(layout_default, { style: ve, ...l ?? {} }, import_react128.default.createElement(row_default, { justify: "center", align: y ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: y ? "15dvh" : "16px" } }, import_react128.default.createElement(col_default, { xs: 22 }, i ? i(B, a) : import_react128.default.createElement(import_react128.default.Fragment, null, a, B))));
}, "LoginPage");
var { Text: $o, Title: ld } = typography_default;
var { useToken: pd } = theme_default;
var qo = t(({ providers: e2, loginLink: o2, wrapperProps: n2, contentProps: r, renderContent: s, formProps: l, title: i, hideForm: d }) => {
  let { token: c } = pd(), [y] = form_default.useForm(), p = _(), P = q(), T = ft(), { Link: h } = ne(), F = P === "legacy" ? h : T, u = Y(), { mutate: f, isLoading: x } = Yr({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), m = i === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react129.default.createElement(ce, { collapsed: false })), C = import_react129.default.createElement(ld, { level: 3, style: { color: c.colorPrimaryTextHover, ...Ee } }, p("pages.register.title", "Sign up for your account")), a = t(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((v) => import_react129.default.createElement(button_default, { key: v.name, type: "default", block: true, icon: v.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => f({ providerName: v.name }) }, v.label)), !d && import_react129.default.createElement(divider_default, null, import_react129.default.createElement($o, { style: { color: c.colorTextLabel } }, p("pages.login.divider", "or")))) : null, "renderProviders"), S2 = import_react129.default.createElement(card_default, { title: C, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: c.colorBgElevated }, ...r ?? {} }, a(), !d && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (v) => f(v), requiredMark: false, ...l }, import_react129.default.createElement(form_default.Item, { name: "email", label: p("pages.register.email", "Email"), rules: [{ required: true }, { type: "email", message: p("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: p("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: p("pages.register.fields.password", "Password"), rules: [{ required: true }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, o2 ?? import_react129.default.createElement($o, { style: { fontSize: 12, marginLeft: "auto" } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(F, { style: { fontWeight: "bold", color: c.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: x, block: true }, p("pages.register.buttons.submit", "Sign up")))), d && o2 !== false && import_react129.default.createElement("div", { style: { marginTop: d ? 16 : 8 } }, import_react129.default.createElement($o, { style: { fontSize: 12 } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(F, { style: { fontWeight: "bold", color: c.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))));
  return import_react129.default.createElement(layout_default, { style: ve, ...n2 ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: d ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: d ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, s ? s(S2, m) : import_react129.default.createElement(import_react129.default.Fragment, null, m, S2))));
}, "RegisterPage");
var { Text: Fd, Title: Bd } = typography_default;
var { useToken: Sd } = theme_default;
var Yo = t(({ loginLink: e2, wrapperProps: o2, contentProps: n2, renderContent: r, formProps: s, title: l }) => {
  let { token: i } = Sd(), [d] = form_default.useForm(), c = _(), y = q(), p = ft(), { Link: P } = ne(), T = y === "legacy" ? P : p, { mutate: h, isLoading: F } = Zr(), u = l === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, l ?? import_react130.default.createElement(ce, { collapsed: false })), f = import_react130.default.createElement(Bd, { level: 3, style: { color: i.colorPrimaryTextHover, ...Ee } }, c("pages.forgotPassword.title", "Forgot your password?")), x = import_react130.default.createElement(card_default, { title: f, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: i.colorBgElevated }, ...n2 ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (m) => h(m), requiredMark: false, ...s }, import_react130.default.createElement(form_default.Item, { name: "email", label: c("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: c("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: c("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(Fd, { style: { fontSize: 12, marginLeft: "auto" } }, c("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(T, { style: { fontWeight: "bold", color: i.colorPrimaryTextHover }, to: "/login" }, c("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: F, block: true }, c("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ve, ...o2 ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, r ? r(x, u) : import_react130.default.createElement(import_react130.default.Fragment, null, u, x))));
}, "ForgotPasswordPage");
var { Title: Ad } = typography_default;
var { useToken: Hd } = theme_default;
var _o = t(({ wrapperProps: e2, contentProps: o2, renderContent: n2, formProps: r, title: s }) => {
  let { token: l } = Hd(), [i] = form_default.useForm(), d = _(), c = Y(), { mutate: y, isLoading: p } = eo({ v3LegacyAuthProviderCompatible: !!(c != null && c.isLegacy) }), P = s === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, s ?? import_react131.default.createElement(ce, { collapsed: false })), T = import_react131.default.createElement(Ad, { level: 3, style: { color: l.colorPrimaryTextHover, ...Ee } }, d("pages.updatePassword.title", "Set New Password")), h = import_react131.default.createElement(card_default, { title: T, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: l.colorBgElevated }, ...o2 ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: i, onFinish: (F) => y(F), requiredMark: false, ...r }, import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true }, ({ getFieldValue: F }) => ({ validator(u, f) {
    return !f || F("password") === f ? Promise.resolve() : Promise.reject(new Error(d("pages.updatePassword.errors.confirmPasswordNotMatch", "Passwords do not match")));
  } })] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: p, block: true }, d("pages.updatePassword.buttons.submit", "Update")))));
  return import_react131.default.createElement(layout_default, { style: ve, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, n2 ? n2(h, P) : import_react131.default.createElement(import_react131.default.Fragment, null, P, h))));
}, "UpdatePasswordPage");
var Od = t((e2) => {
  let { type: o2 } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, t(() => {
    switch (o2) {
      case "register":
        return import_react127.default.createElement(qo, { ...e2 });
      case "forgotPassword":
        return import_react127.default.createElement(Yo, { ...e2 });
      case "updatePassword":
        return import_react127.default.createElement(_o, { ...e2 });
      default:
        return import_react127.default.createElement(Go, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var Be = t(({ breadcrumbProps: e2, showHome: o2 = true, hideIcons: n2 = false, meta: r }) => {
  let s = q(), { breadcrumbs: l } = xb({ meta: r }), i = ft(), { Link: d } = ne(), { hasDashboard: c } = oe(), { resources: y } = G(), p = Mo("/", y), P = s === "legacy" ? d : i;
  if (l.length === 1)
    return null;
  let T = l.map(({ label: F, icon: u, href: f }) => ({ key: `breadcrumb-item-${F}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !n2 && u, f ? import_react132.default.createElement(P, { to: f }, F) : import_react132.default.createElement("span", null, F)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: t(() => {
    var F, u;
    return o2 && (c || p.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(P, { to: "/" }, ((u = (F = p == null ? void 0 : p.resource) == null ? void 0 : F.meta) == null ? void 0 : u.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...T] : T;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var Se = t(({ children: e2, ...o2 }) => {
  let n2 = typeof o2.backIcon > "u" ? import_react133.default.createElement(button_default, { type: "text", icon: import_react133.default.createElement(ArrowLeftOutlined_default, null) }) : o2.backIcon, r = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, o2.title) : o2.title, s = typeof o2.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, o2.subTitle) : o2.subTitle;
  return import_react133.default.createElement(PageHeader, { ...o2, backIcon: n2, title: r, subTitle: s, style: { padding: 0, ...o2.style } }, e2);
}, "PageHeader");
var It = t(({ status: e2, elements: { success: o2 = import_react134.default.createElement(po, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: n2 = import_react134.default.createElement(po, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: r = import_react134.default.createElement(po, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: s = import_react134.default.createElement(po, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(Eu, { status: e2, elements: { success: o2, error: n2, loading: r, idle: s } }), "AutoSaveIndicator");
var po = t(({ key: e2, defaultMessage: o2, icon: n2 }) => {
  let r = _(), { useToken: s } = theme_default, { token: l } = s();
  return import_react134.default.createElement(typography_default.Text, { style: { marginRight: 5, color: l.colorTextTertiary, fontSize: ".8rem" } }, r(e2, o2), import_react134.default.createElement("span", { style: { marginLeft: ".2rem" } }, n2));
}, "Message");
var sm2 = t((e2) => {
  let { fileList: o2 } = e2;
  return [...o2];
}, "getValueFromEvent");
var MF = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  Od as AuthPage,
  ...
  xs as ThemedLayout,
  Ie as ThemedLayoutContext,
  bo as ThemedLayoutContextProvider,
  ia as ThemedLayoutV2,
  vo2 as ThemedSider,
  wo as ThemedSiderV2,
  Lo as ThemedTitle,
  ce as ThemedTitleV2,
  ...
  jo as UrlField,
  Ru as WelcomePage,
  vr2 as getDefaultFilter,
  Sr as getDefaultSortOrder,
  sm2 as getValueFromEvent,
  fo as mapAntdFilterToCrudFilter,
  co2 as mapAntdSorterToCrudSorting,
  tT as notificationProvider,
  zf as useCheckboxGroup,
  rt as useDrawerForm,
  Or as useEditableTable,
  Ey as useFileUploadState,
  Te as useForm,
  uy as useImport,
  Jo as useModal,
  ot as useModalForm,
  rT as useNotificationProvider,
  Xf as useRadioGroup,
  Rf as useSelect,
  Qy as useSiderVisible,
  Xr as useSimpleList,
  nt as useStepsForm,
  To as useTable,
  mt as useThemedLayoutContext
};
