...
// node_modules/@refinedev/react-router-v6/dist/esm/index.js
...
var D = { go: () => {
  ...
  return (0, import_react2.useCallback)(({ to: s, type: n, query: o, hash: a, options: { keepQuery: c, keepHash: f } = {} }) => {
    let u = { ...c && e && (0, import_qs.parse)(e, { ignoreQueryPrefix: true }), ...o };
    u.to && (u.to = encodeURIComponent(`${u.to}`));
    let m = Object.keys(u).length > 0, p = `#${(a || f && t || "").replace(/^#/, "")}`, U = p.length > 1, R = `${s || ""}${m ? (0, import_qs.stringify)(u, x) : ""}${U ? p : ""}`;
    return n === "path" ? R : r(R, { replace: n === "replace" });
  }, [t, e, r]);
}, back: () => {
  let e = useNavigate();
  ...
  var c;
  let e = useParams(), { pathname: t, search: r } = useLocation(), { resources: i } = (0, import_react2.useContext)(it), { resource: s, action: n, matchedRoute: o } = import_react.default.useMemo(() => Mo(t, i), [i, t]);
  return Object.entries(e).length === 0 && o && (e = ((c = matchPath(o, t)) == null ? void 0 : c.params) || {}), (0, import_react2.useCallback)(() => {
    let f = (0, import_qs.parse)(r, { ignoreQueryPrefix: true }), u = { ...e, ...f };
...
var N = (e) => e.flatMap((r) => {
  ...
  return ["list", "show", "edit", "create"].forEach((s) => {
    ...
    if (typeof n < "u" && typeof n != "string") {
      let o = typeof n == "function" ? n : n.component, a = B(r, s);
...
var G2 = ({ children: e }) => {
  let { resources: t } = G(), r = import_react3.default.useMemo(() => N(t), [t]);
  return e ? e(r) : import_react3.default.createElement(Routes, null, r);
};
var q = ({ resource: e, meta: t }) => {
  let r = mt(), { resource: i, resources: s } = G(e), n = i || s.find((o) => o.list);
  if (n) {
...
var _2 = ({ translationKey: e = "warnWhenUnsavedChanges", message: t = "Are you sure you want to leave? You have unsaved changes." }) => {
  let r = _(), { pathname: i } = useLocation(), { warnWhen: s, setWarnWhen: n } = Ht();
...
function ce({ handler: e }) {
  var m;
  let t = useLocation(), { action: r, id: i, params: s, pathname: n, resource: o } = ye(), a = _(), c = Dt(), f = (o == null ? void 0 : o.identifier) ?? (o == null ? void 0 : o.name), u = (o == null ? void 0 : o.label) ?? ((m = o == null ? void 0 : o.meta) == null ? void 0 : m.label) ?? c(f, r === "list" ? "plural" : "singular");
...
export {
  ...
  q as NavigateToResource,
  G2 as RefineRoutes,
  _2 as UnsavedChangesNotifier,
  D as default,
